...
#
package WWW::OpenAPIClient::CreateATransactionApi;
...
# @param PreparePaymentTransactionRequestSchema $prepare_payment_transaction_request_schema  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'prepare_transaction_request1' } = {
...
#
sub prepare_transaction_request1 {
    my ($self, %args) = @_;

    # verify the required parameter 'authorization' is set
    unless (exists $args{'authorization'}) {
      croak("Missing the required parameter 'authorization' when calling prepare_transaction_request1");
    }
    ...
    unless (exists $args{'prepare_payment_transaction_request_schema'}) {
      croak("Missing the required parameter 'prepare_payment_transaction_request_schema' when calling prepare_transaction_request1");
    }
