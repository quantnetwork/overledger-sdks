...
#
package WWW::OpenAPIClient::Object::Block;
...
__PACKAGE__->method_documentation({
    ...
    'transaction_ids' => {
        ...
        base_name => 'transactionIds',
        description => '',
        format => '',
        read_only => '',
            },
    'size' => {
        datatype => 'ARRAY[BlockSize]',
        base_name => 'size',
        description => '',
        format => '',
        read_only => '',
    ...
    'linked_blocks' => {
        datatype => 'LinkedBlocks',
        base_name => 'linkedBlocks',
        description => '',
        format => '',
        read_only => '',
            },
    'number_of_transactions' => {
        datatype => 'int',
        base_name => 'numberOfTransactions',
        description => '',
        format => '',
        read_only => '',
            },
