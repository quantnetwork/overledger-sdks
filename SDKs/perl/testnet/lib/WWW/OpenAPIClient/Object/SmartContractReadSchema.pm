...
#
package WWW::OpenAPIClient::Object::SmartContractReadSchema;
...
__PACKAGE__->class_documentation({description => 'Computer program storage in a DLT system where the outcome is recorded on the distributed ledger',
