...
#
package WWW::OpenAPIClient::Object::AutoExecuteSearchAddressBalanceResponseSchema;
...
__PACKAGE__->method_documentation({
    ...
    'execution_address_balance_search_response' => {
        datatype => 'PrepareAndExecuteSearchAddressBalanceResponse',
        base_name => 'executionAddressBalanceSearchResponse',
        description => '',
        format => '',
        read_only => '',
            },
    'preparation_address_balance_search_response' => {
        datatype => 'PrepareSearchResponseSchema',
        base_name => 'preparationAddressBalanceSearchResponse',
        description => '',
        format => '',
        read_only => '',
            },
