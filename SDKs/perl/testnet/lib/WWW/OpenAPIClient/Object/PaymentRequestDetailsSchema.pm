...
#
package WWW::OpenAPIClient::Object::PaymentRequestDetailsSchema;
...
__PACKAGE__->class_documentation({description => 'The payload request',
...
__PACKAGE__->method_documentation({
    'destination' => {
        datatype => 'ARRAY[DestinationPaymentSchema]',
    ...
    'origin' => {
        datatype => 'ARRAY[OriginPaymentSchema]',
        base_name => 'origin',
