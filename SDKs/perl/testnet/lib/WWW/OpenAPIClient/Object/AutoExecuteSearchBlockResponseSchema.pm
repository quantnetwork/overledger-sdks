...
#
package WWW::OpenAPIClient::Object::AutoExecuteSearchBlockResponseSchema;
...
__PACKAGE__->method_documentation({
    ...
    'execution_block_search_response' => {
        datatype => 'ExecuteSearchBlockResponse',
        base_name => 'executionBlockSearchResponse',
        description => '',
        format => '',
        read_only => '',
            },
    'preparation_block_search_response' => {
        datatype => 'PrepareSearchResponseSchema',
        base_name => 'preparationBlockSearchResponse',
        description => '',
        format => '',
        read_only => '',
            },
