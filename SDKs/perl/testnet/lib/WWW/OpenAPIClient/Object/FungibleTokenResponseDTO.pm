...
#
package WWW::OpenAPIClient::Object::FungibleTokenResponseDTO;
...
__PACKAGE__->method_documentation({
    ...
    'decimal_places' => {
        datatype => 'int',
        base_name => 'decimalPlaces',
        description => '',
        format => '',
        read_only => '',
            },
    'functions' => {
        datatype => 'ARRAY[FunctionDTO]',
        base_name => 'functions',
        description => '',
        format => '',
        read_only => '',
