...
#
package WWW::OpenAPIClient::ManageQRC20TokenSupplyApi;
...
#
# @param string $authorization  (required)
# @param PrepareMintTransactionRequestSchemaQrc20 $prepare_mint_transaction_request_schema_qrc20  (required)
{
    my $params = {
    'authorization' => {
        data_type => 'string',
    ...
    'prepare_mint_transaction_request_schema_qrc20' => {
        data_type => 'PrepareMintTransactionRequestSchemaQrc20',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'prepare_supply_request1' } = {
...
#
sub prepare_supply_request1 {
    my ($self, %args) = @_;

    # verify the required parameter 'authorization' is set
    unless (exists $args{'authorization'}) {
      croak("Missing the required parameter 'authorization' when calling prepare_supply_request1");
    }

    # verify the required parameter 'prepare_mint_transaction_request_schema_qrc20' is set
    unless (exists $args{'prepare_mint_transaction_request_schema_qrc20'}) {
      croak("Missing the required parameter 'prepare_mint_transaction_request_schema_qrc20' when calling prepare_supply_request1");
    }

    # parse inputs
    my $_resource_path = '/v2/preparation/supply';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'prepare_mint_transaction_request_schema_qrc20'}) {
        $_body_data = $args{'prepare_mint_transaction_request_schema_qrc20'};
    }
