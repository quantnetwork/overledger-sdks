...
#
package WWW::OpenAPIClient::Object::AutoExecSearchAddressSequenceResponseSchema;
...
__PACKAGE__->method_documentation({
    ...
    'execution_address_sequence_search_response' => {
        datatype => 'ExecuteSearchSequenceResponse',
        base_name => 'executionAddressSequenceSearchResponse',
        description => '',
        format => '',
        read_only => '',
            },
