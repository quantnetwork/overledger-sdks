...
#
package WWW::OpenAPIClient::Object::CreateSmartContractMonitoringSchema;
...
__PACKAGE__->method_documentation({
    ...
    'subscription_details' => {
        datatype => 'ResourceMonitoringSubscriptionDetails',
    ...
    'subscription' => {
        datatype => 'ResourceMonitoringSubscription',
