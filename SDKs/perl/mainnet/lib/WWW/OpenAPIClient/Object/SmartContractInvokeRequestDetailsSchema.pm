...
#
package WWW::OpenAPIClient::Object::SmartContractInvokeRequestDetailsSchema;
...
__PACKAGE__->method_documentation({
    'origin' => {
        datatype => 'ARRAY[SmartContractRequestDetailsOrigin]',
        base_name => 'origin',
        description => '',
        format => '',
        read_only => '',
    ...
    'destination' => {
        datatype => 'ARRAY[SmartContractDestinationSchema]',
