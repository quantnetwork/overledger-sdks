...
use_ok('WWW::OpenAPIClient::ManageSubscriptionsApi');

my $api = WWW::OpenAPIClient::ManageSubscriptionsApi->new();
isa_ok($api, 'WWW::OpenAPIClient::ManageSubscriptionsApi');
...
#my $update_subscription_update_webhook_subscription_request_schema = undef; # replace NULL with a proper value
#my $update_subscription_result = $api->update_subscription(authorization => $update_subscription_authorization, subscription_id => $update_subscription_subscription_id, update_webhook_subscription_request_schema => $update_subscription_update_webhook_subscription_request_schema);
