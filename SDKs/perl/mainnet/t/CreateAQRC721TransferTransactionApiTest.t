...
use_ok('WWW::OpenAPIClient::CreateAQRC721TransferTransactionApi');

my $api = WWW::OpenAPIClient::CreateAQRC721TransferTransactionApi->new();
isa_ok($api, 'WWW::OpenAPIClient::CreateAQRC721TransferTransactionApi');
