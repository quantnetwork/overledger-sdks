...
#include <stdio.h>
#include <ctype.h>
#include "RetrieveApprovedAccountInformationOfAQRC721TokenAPI.h"
...
RetrieveApprovedAccountInformationOfAQRC721TokenAPI_readQRC721SmartContractApprovedAccount(apiClient_t *apiClient, char * Authorization , read_approved_account_request_schema_t * read_approved_account_request_schema )
{
    ...
    // create the path
    long sizeOfPath = strlen("/v2/tokenise/tokens/qrc721/approved-account")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/v2/tokenise/tokens/qrc721/approved-account");
    ...
    cJSON *RetrieveApprovedAccountInformationOfAQRC721TokenAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    token_read_qrc721_response_t *elementToReturn = token_read_qrc721_response_parseFromJSON(RetrieveApprovedAccountInformationOfAQRC721TokenAPIlocalVarJSON);
    cJSON_Delete(RetrieveApprovedAccountInformationOfAQRC721TokenAPIlocalVarJSON);
