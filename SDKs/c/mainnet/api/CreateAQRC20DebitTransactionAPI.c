...
#include <stdio.h>
#include <ctype.h>
#include "CreateAQRC20DebitTransactionAPI.h"
...
CreateAQRC20DebitTransactionAPI_executePreparedRequestTransaction(apiClient_t *apiClient, char * Authorization , execute_transaction_request_t * execute_transaction_request )
{
    ...
    cJSON *CreateAQRC20DebitTransactionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    execute_transaction_response_t *elementToReturn = execute_transaction_response_parseFromJSON(CreateAQRC20DebitTransactionAPIlocalVarJSON);
    cJSON_Delete(CreateAQRC20DebitTransactionAPIlocalVarJSON);
...
CreateAQRC20DebitTransactionAPI_prepareDebitRequest(apiClient_t *apiClient, char * Authorization , prepare_credit_transaction_request_schema_t * prepare_credit_transaction_request_schema )
{
    ...
    // create the path
    long sizeOfPath = strlen("/v2/preparation/debit")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/v2/preparation/debit");
    ...
    //nonprimitive not container
    cJSON *CreateAQRC20DebitTransactionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    prepare_transaction_response_t *elementToReturn = prepare_transaction_response_parseFromJSON(CreateAQRC20DebitTransactionAPIlocalVarJSON);
    cJSON_Delete(CreateAQRC20DebitTransactionAPIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
