...
#include <stdio.h>
#include <ctype.h>
#include "SubscribeToQRC721AssetCollectionUpdatesAPI.h"
...
SubscribeToQRC721AssetCollectionUpdatesAPI_subscribeCollectEvent(apiClient_t *apiClient, char * Authorization , object_t * body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/v2/tokenise/tokens/subscription/qrc721/collect")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/v2/tokenise/tokens/subscription/qrc721/collect");
    ...
    cJSON *SubscribeToQRC721AssetCollectionUpdatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    event_subscription_response_t *elementToReturn = event_subscription_response_parseFromJSON(SubscribeToQRC721AssetCollectionUpdatesAPIlocalVarJSON);
    cJSON_Delete(SubscribeToQRC721AssetCollectionUpdatesAPIlocalVarJSON);
