...
#include <stdio.h>
#include <ctype.h>
#include "SubscribeToQRC20SharedAccountUpdatesAPI.h"
...
SubscribeToQRC20SharedAccountUpdatesAPI_subscribeSecondaryOwnerEvent(apiClient_t *apiClient, char * Authorization , object_t * body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/v2/tokenise/tokens/subscription/qrc20/secondaryaccountowner")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/v2/tokenise/tokens/subscription/qrc20/secondaryaccountowner");
    ...
    cJSON *SubscribeToQRC20SharedAccountUpdatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    event_subscription_response_t *elementToReturn = event_subscription_response_parseFromJSON(SubscribeToQRC20SharedAccountUpdatesAPIlocalVarJSON);
    cJSON_Delete(SubscribeToQRC20SharedAccountUpdatesAPIlocalVarJSON);
