...
#include <stdio.h>
#include <ctype.h>
#include "SubscribeToQRC20AccountDebitPaymentsAPI.h"
...
SubscribeToQRC20AccountDebitPaymentsAPI_subscribeQRC20DebitEvent(apiClient_t *apiClient, char * Authorization , object_t * body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/v2/tokenise/tokens/subscription/qrc20/debit")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/v2/tokenise/tokens/subscription/qrc20/debit");
    ...
    cJSON *SubscribeToQRC20AccountDebitPaymentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    event_subscription_response_t *elementToReturn = event_subscription_response_parseFromJSON(SubscribeToQRC20AccountDebitPaymentsAPIlocalVarJSON);
    cJSON_Delete(SubscribeToQRC20AccountDebitPaymentsAPIlocalVarJSON);
