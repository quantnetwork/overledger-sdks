...
#include <stdio.h>
#include <ctype.h>
#include "SubscribeToQRC20AccountCreditPaymentsAPI.h"
...
SubscribeToQRC20AccountCreditPaymentsAPI_subscribeCreditEvent(apiClient_t *apiClient, char * Authorization , object_t * body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/v2/tokenise/tokens/subscription/qrc20/credit")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/v2/tokenise/tokens/subscription/qrc20/credit");
    ...
    cJSON *SubscribeToQRC20AccountCreditPaymentsAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    event_subscription_response_t *elementToReturn = event_subscription_response_parseFromJSON(SubscribeToQRC20AccountCreditPaymentsAPIlocalVarJSON);
    cJSON_Delete(SubscribeToQRC20AccountCreditPaymentsAPIlocalVarJSON);
