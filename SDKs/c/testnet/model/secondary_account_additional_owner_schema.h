/*
 * secondary_account_additional_owner_schema.h
 *
 * 
 */

#ifndef _secondary_account_additional_owner_schema_H_
#define _secondary_account_additional_owner_schema_H_
...
typedef struct secondary_account_additional_owner_schema_t secondary_account_additional_owner_schema_t;




typedef struct secondary_account_additional_owner_schema_t {
    char *account_id; // string

} secondary_account_additional_owner_schema_t;
...
#endif /* _secondary_account_additional_owner_schema_H_ */
