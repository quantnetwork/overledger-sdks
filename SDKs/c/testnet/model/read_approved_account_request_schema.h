/*
 * read_approved_account_request_schema.h
 *
 * 
 */

#ifndef _read_approved_account_request_schema_H_
#define _read_approved_account_request_schema_H_
...
typedef struct read_approved_account_request_schema_t read_approved_account_request_schema_t;
...
typedef struct read_approved_account_request_schema_t {
    struct read_approved_account_request_details_schema_t *request_details; //model
    struct location_t *location; //model

} read_approved_account_request_schema_t;
...
#endif /* _read_approved_account_request_schema_H_ */
