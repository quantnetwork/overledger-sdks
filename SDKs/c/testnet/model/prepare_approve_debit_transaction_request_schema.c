...
char* typeprepare_approve_debit_transaction_request_schema_ToString(quant_overledger_api_prepare_approve_debit_transaction_request_schema_TYPE_e type) {
    char* typeArray[] =  { "NULL", "Payment", "Transfer", "Contract Invoke" };
	return typeArray[type];
}

quant_overledger_api_prepare_approve_debit_transaction_request_schema_TYPE_e typeprepare_approve_debit_transaction_request_schema_FromString(char* type){
...
char* urgencyprepare_approve_debit_transaction_request_schema_ToString(quant_overledger_api_prepare_approve_debit_transaction_request_schema_URGENCY_e urgency) {
    char* urgencyArray[] =  { "NULL", "Normal", "Fast", "Urgent" };
	return urgencyArray[urgency];
}

quant_overledger_api_prepare_approve_debit_transaction_request_schema_URGENCY_e urgencyprepare_approve_debit_transaction_request_schema_FromString(char* urgency){
    int stringToReturn = 0;
    char *urgencyArray[] =  { "NULL", "Normal", "Fast", "Urgent" };
...
cJSON *prepare_approve_debit_transaction_request_schema_convertToJSON(prepare_approve_debit_transaction_request_schema_t *prepare_approve_debit_transaction_request_schema) {
    ...
    if(cJSON_AddStringToObject(item, "type", typeprepare_approve_debit_transaction_request_schema_ToString(prepare_approve_debit_transaction_request_schema->type)) == NULL)
    {
    goto fail; //Enum
    }
    ...
    if(cJSON_AddStringToObject(item, "urgency", urgencyprepare_approve_debit_transaction_request_schema_ToString(prepare_approve_debit_transaction_request_schema->urgency)) == NULL)
    {
    goto fail; //Enum
    }
...
prepare_approve_debit_transaction_request_schema_t *prepare_approve_debit_transaction_request_schema_parseFromJSON(cJSON *prepare_approve_debit_transaction_request_schemaJSON){
    ...
    quant_overledger_api_prepare_approve_debit_transaction_request_schema_TYPE_e typeVariable;
    
    if(!cJSON_IsString(type))
    {
    goto end; //Enum
    }
    typeVariable = typeprepare_approve_debit_transaction_request_schema_FromString(type->valuestring);
    ...
    quant_overledger_api_prepare_approve_debit_transaction_request_schema_URGENCY_e urgencyVariable;
    
    if(!cJSON_IsString(urgency))
    {
    goto end; //Enum
    }
    urgencyVariable = urgencyprepare_approve_debit_transaction_request_schema_FromString(urgency->valuestring);
