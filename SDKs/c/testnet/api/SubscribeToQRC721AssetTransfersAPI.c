...
#include <stdio.h>
#include <ctype.h>
#include "SubscribeToQRC721AssetTransfersAPI.h"
...
SubscribeToQRC721AssetTransfersAPI_subscribeTransferEvent(apiClient_t *apiClient, char * Authorization , object_t * body )
{
    ...
    // create the path
    long sizeOfPath = strlen("/v2/tokenise/tokens/subscription/qrc721/transfer")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/v2/tokenise/tokens/subscription/qrc721/transfer");
    ...
    cJSON *SubscribeToQRC721AssetTransfersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    event_subscription_response_t *elementToReturn = event_subscription_response_parseFromJSON(SubscribeToQRC721AssetTransfersAPIlocalVarJSON);
    cJSON_Delete(SubscribeToQRC721AssetTransfersAPIlocalVarJSON);
