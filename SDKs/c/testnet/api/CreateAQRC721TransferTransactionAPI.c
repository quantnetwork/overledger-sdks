...
#include <stdio.h>
#include <ctype.h>
#include "CreateAQRC721TransferTransactionAPI.h"
...
CreateAQRC721TransferTransactionAPI_prepareTransactionRequest(apiClient_t *apiClient, char * Authorization , prepare_payment_transaction_request_schema_t * prepare_payment_transaction_request_schema )
{
    ...
    // create the path
    long sizeOfPath = strlen("/v2/tokenise/preparation/transaction/qrc721/transfer")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/v2/tokenise/preparation/transaction/qrc721/transfer");
    ...
    cJSON *CreateAQRC721TransferTransactionAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    prepare_transaction_response_t *elementToReturn = prepare_transaction_response_parseFromJSON(CreateAQRC721TransferTransactionAPIlocalVarJSON);
    cJSON_Delete(CreateAQRC721TransferTransactionAPIlocalVarJSON);
