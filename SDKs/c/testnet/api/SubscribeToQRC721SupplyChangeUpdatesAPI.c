...
#include <stdio.h>
#include <ctype.h>
#include "SubscribeToQRC721SupplyChangeUpdatesAPI.h"
...
SubscribeToQRC721SupplyChangeUpdatesAPI_subscribeSupplyEvent(apiClient_t *apiClient, char * Authorization , char * flowtype , object_t * body )
{
    ...
    cJSON *SubscribeToQRC721SupplyChangeUpdatesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    event_subscription_response_t *elementToReturn = event_subscription_response_parseFromJSON(SubscribeToQRC721SupplyChangeUpdatesAPIlocalVarJSON);
    cJSON_Delete(SubscribeToQRC721SupplyChangeUpdatesAPIlocalVarJSON);
