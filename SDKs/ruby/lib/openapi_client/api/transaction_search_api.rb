  ...
  class TransactionSearchApi
    ...
    def execute_prepared_search_request_transaction_with_http_info(authorization, request_id, opts = {})
      ...
      if @api_client.config.client_side_validation && authorization.to_s.length > 1024
        fail ArgumentError, 'invalid value for "authorization" when calling TransactionSearchApi.execute_prepared_search_request_transaction, the character length must be smaller than or equal to 1024.'
      end
    ...
    def prepare_search_request_with_http_info(authorization, transaction_id, prepare_search_schema, opts = {})
      ...
      if @api_client.config.client_side_validation && authorization.to_s.length > 1024
        fail ArgumentError, 'invalid value for "authorization" when calling TransactionSearchApi.prepare_search_request, the character length must be smaller than or equal to 1024.'
      end
