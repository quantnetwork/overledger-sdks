  ...
  class Transfer
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Transfer` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Transfer`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@token_id.nil? && @token_id.to_s.length > 15
        invalid_properties.push('invalid value for "token_id", the character length must be smaller than or equal to 15.')
      end
      ...
      pattern = Regexp.new(/^[A-Za-z0-9 ]{1,15}/)
      if !@token_id.nil? && @token_id !~ pattern
        invalid_properties.push("invalid value for \"token_id\", must conform to the pattern #{pattern}.")
      end

      if !@token_name.nil? && @token_name.to_s.length > 15
        invalid_properties.push('invalid value for "token_name", the character length must be smaller than or equal to 15.')
      end
    ...
    def valid?
      return false if !@token_id.nil? && @token_id.to_s.length > 15
      return false if !@token_id.nil? && @token_id.to_s.length < 0
      return false if !@token_id.nil? && @token_id !~ Regexp.new(/^[A-Za-z0-9 ]{1,15}/)
      return false if !@token_name.nil? && @token_name.to_s.length > 15
      return false if !@token_name.nil? && @token_name.to_s.length < 0
      return false if !@token_name.nil? && @token_name !~ Regexp.new(/^[A-Za-z0-9 ]{1,15}/)
      true
    end
    ...
    def token_id=(token_id)
      if !token_id.nil? && token_id.to_s.length > 15
        fail ArgumentError, 'invalid value for "token_id", the character length must be smaller than or equal to 15.'
      end
    ...
    def token_name=(token_name)
      if !token_name.nil? && token_name.to_s.length > 15
        fail ArgumentError, 'invalid value for "token_name", the character length must be smaller than or equal to 15.'
      end
