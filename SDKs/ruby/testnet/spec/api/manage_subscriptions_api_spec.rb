...
# Unit tests for OpenapiClient::ManageSubscriptionsApi
...
describe 'ManageSubscriptionsApi' do
  ...
  describe 'test an instance of ManageSubscriptionsApi' do
    it 'should create an instance of ManageSubscriptionsApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::ManageSubscriptionsApi)
    end
  end
  ...
  # @param authorization 
  # @param subscription_id 
  # @param update_webhook_subscription_request_schema 
  # @param [Hash] opts the optional parameters
  # @return [WebhookSubscriptionStatusUpdateResponse]
