...
module OpenapiClient
  class TransactionSearchApi
    ...
    def auto_execute_search_transaction_request(authorization, transaction_id, prepare_search_schema, opts = {})
      data, _status_code, _headers = auto_execute_search_transaction_request_with_http_info(authorization, transaction_id, prepare_search_schema, opts)
      data
    end
    ...
    # @param prepare_search_schema [PrepareSearchSchema] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PrepareAndExecuteTransactionResponse, Integer, Hash)>] PrepareAndExecuteTransactionResponse data, response status code and response headers
    def auto_execute_search_transaction_request_with_http_info(authorization, transaction_id, prepare_search_schema, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TransactionSearchApi.auto_execute_search_transaction_request ...'
      end
      # verify the required parameter 'authorization' is set
      if @api_client.config.client_side_validation && authorization.nil?
        fail ArgumentError, "Missing the required parameter 'authorization' when calling TransactionSearchApi.auto_execute_search_transaction_request"
      end
      if @api_client.config.client_side_validation && authorization.to_s.length > 5010
        fail ArgumentError, 'invalid value for "authorization" when calling TransactionSearchApi.auto_execute_search_transaction_request, the character length must be smaller than or equal to 5010.'
      end

      if @api_client.config.client_side_validation && authorization.to_s.length < 0
        fail ArgumentError, 'invalid value for "authorization" when calling TransactionSearchApi.auto_execute_search_transaction_request, the character length must be great than or equal to 0.'
      end

      pattern = Regexp.new(/^Bearer [A-Za-z0-9\-_. ]{1,5010}$/)
      if @api_client.config.client_side_validation && authorization !~ pattern
        fail ArgumentError, "invalid value for 'authorization' when calling TransactionSearchApi.auto_execute_search_transaction_request, must conform to the pattern #{pattern}."
      end

      # verify the required parameter 'transaction_id' is set
      if @api_client.config.client_side_validation && transaction_id.nil?
        fail ArgumentError, "Missing the required parameter 'transaction_id' when calling TransactionSearchApi.auto_execute_search_transaction_request"
      end
      if @api_client.config.client_side_validation && transaction_id.to_s.length > 100
        fail ArgumentError, 'invalid value for "transaction_id" when calling TransactionSearchApi.auto_execute_search_transaction_request, the character length must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && transaction_id.to_s.length < 0
        fail ArgumentError, 'invalid value for "transaction_id" when calling TransactionSearchApi.auto_execute_search_transaction_request, the character length must be great than or equal to 0.'
      end

      pattern = Regexp.new(/^[a-zA-Z0-9]{1,100}$/)
      if @api_client.config.client_side_validation && transaction_id !~ pattern
        fail ArgumentError, "invalid value for 'transaction_id' when calling TransactionSearchApi.auto_execute_search_transaction_request, must conform to the pattern #{pattern}."
      end
      ...
      if @api_client.config.client_side_validation && prepare_search_schema.nil?
        fail ArgumentError, "Missing the required parameter 'prepare_search_schema' when calling TransactionSearchApi.auto_execute_search_transaction_request"
      end
      # resource path
      local_var_path = '/v2/autoexecution/search/transaction'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PrepareAndExecuteTransactionResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['OAuth2_Security_Scheme']

      new_options = opts.merge(
        :operation => :"TransactionSearchApi.auto_execute_search_transaction_request",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TransactionSearchApi#auto_execute_search_transaction_request\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def execute_prepared_search_request_transaction_with_http_info(authorization, request_id, opts = {})
      ...
      if @api_client.config.client_side_validation && authorization.to_s.length > 5010
        fail ArgumentError, 'invalid value for "authorization" when calling TransactionSearchApi.execute_prepared_search_request_transaction, the character length must be smaller than or equal to 5010.'
      end
    ...
    def prepare_search_request_with_http_info(authorization, transaction_id, prepare_search_schema, opts = {})
      ...
      if @api_client.config.client_side_validation && authorization.to_s.length > 5010
        fail ArgumentError, 'invalid value for "authorization" when calling TransactionSearchApi.prepare_search_request, the character length must be smaller than or equal to 5010.'
      end
