...
module OpenapiClient
  class PrepareRequest
    attr_accessor :api_lookup_path

    attr_accessor :smart_contract_tag
    ...
    def self.openapi_types
      {
        ...
        :'smart_contract_tag' => :'Array<SmartContractTag>',
        :'urgency' => :'String',
        :'request_details' => :'PrepareRequestDetails',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::PrepareRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::PrepareRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'api_lookup_path')
        self.api_lookup_path = attributes[:'api_lookup_path']
      end

      if attributes.key?(:'smart_contract_tag')
        if (value = attributes[:'smart_contract_tag']).is_a?(Array)
          self.smart_contract_tag = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          api_lookup_path == o.api_lookup_path &&
          smart_contract_tag == o.smart_contract_tag &&
          urgency == o.urgency &&
    ...
    def hash
      [api_lookup_path, smart_contract_tag, urgency, request_details, smart_contract_address, location, type].hash
    end
