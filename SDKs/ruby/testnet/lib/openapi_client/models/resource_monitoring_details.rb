...
module OpenapiClient
  class ResourceMonitoringDetails
    attr_accessor :resource_monitoring_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ResourceMonitoringDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ResourceMonitoringDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'resource_monitoring_id')
        self.resource_monitoring_id = attributes[:'resource_monitoring_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          resource_monitoring_id == o.resource_monitoring_id &&
          location == o.location &&
          type == o.type &&
    ...
    def hash
      [resource_monitoring_id, location, type, timestamp, status].hash
    end
