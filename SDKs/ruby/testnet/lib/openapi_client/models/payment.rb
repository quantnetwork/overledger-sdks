  ...
  class Payment
    ...
    def list_invalid_properties
      ...
      if !@issuer.nil? && @issuer.to_s.length > 20
        invalid_properties.push('invalid value for "issuer", the character length must be smaller than or equal to 20.')
      end

      if !@issuer.nil? && @issuer.to_s.length < 0
        invalid_properties.push('invalid value for "issuer", the character length must be great than or equal to 0.')
      end

      pattern = Regexp.new(/^[A-Za-z0-9 ]{1,20}/)
      if !@issuer.nil? && @issuer !~ pattern
        invalid_properties.push("invalid value for \"issuer\", must conform to the pattern #{pattern}.")
      end
    ...
    def issuer=(issuer)
      if !issuer.nil? && issuer.to_s.length > 20
        fail ArgumentError, 'invalid value for "issuer", the character length must be smaller than or equal to 20.'
      end

      if !issuer.nil? && issuer.to_s.length < 0
        fail ArgumentError, 'invalid value for "issuer", the character length must be great than or equal to 0.'
      end

      pattern = Regexp.new(/^[A-Za-z0-9 ]{1,20}/)
      if !issuer.nil? && issuer !~ pattern
        fail ArgumentError, "invalid value for \"issuer\", must conform to the pattern #{pattern}."
      end
