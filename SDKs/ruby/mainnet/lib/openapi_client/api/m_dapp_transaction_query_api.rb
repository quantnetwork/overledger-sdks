  ...
  class MDappTransactionQueryApi
    ...
    def get_ovl_transaction_by_tx_id_with_http_info(authorization, overledgertransactionid, opts = {})
      ...
      if @api_client.config.client_side_validation && authorization.to_s.length > 1024
        fail ArgumentError, 'invalid value for "authorization" when calling MDappTransactionQueryApi.get_ovl_transaction_by_tx_id, the character length must be smaller than or equal to 1024.'
      end
    ...
    def get_ovl_transactions_by_client_id_with_http_info(authorization, opts = {})
      ...
      if @api_client.config.client_side_validation && authorization.to_s.length > 1024
        fail ArgumentError, 'invalid value for "authorization" when calling MDappTransactionQueryApi.get_ovl_transactions_by_client_id, the character length must be smaller than or equal to 1024.'
      end
