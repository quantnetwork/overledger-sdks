  ...
  class SmartContract
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::SmartContract` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::SmartContract`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@detail.nil? && @detail.to_s.length > 20
        invalid_properties.push('invalid value for "detail", the character length must be smaller than or equal to 20.')
      end

      if !@detail.nil? && @detail.to_s.length < 0
        invalid_properties.push('invalid value for "detail", the character length must be great than or equal to 0.')
      end

      pattern = Regexp.new(/^[A-Za-z0-9]{1,20}$/)
      if !@detail.nil? && @detail !~ pattern
        invalid_properties.push("invalid value for \"detail\", must conform to the pattern #{pattern}.")
      end
      ...
      if !@smart_contract_id.nil? && @smart_contract_id.to_s.length > 44
        invalid_properties.push('invalid value for "smart_contract_id", the character length must be smaller than or equal to 44.')
      end
      ...
      pattern = Regexp.new(/^[A-Za-z0-9]{1,44}$/)
    ...
    def valid?
      return false if !@detail.nil? && @detail.to_s.length > 20
      return false if !@detail.nil? && @detail.to_s.length < 0
      return false if !@detail.nil? && @detail !~ Regexp.new(/^[A-Za-z0-9]{1,20}$/)
      return false if !@type.nil? && @type.to_s.length > 20
      return false if !@type.nil? && @type.to_s.length < 0
      return false if !@type.nil? && @type !~ Regexp.new(/^[A-Za-z0-9]{1,20}$/)
      return false if !@smart_contract_id.nil? && @smart_contract_id.to_s.length > 44
      return false if !@smart_contract_id.nil? && @smart_contract_id.to_s.length < 0
      return false if !@smart_contract_id.nil? && @smart_contract_id !~ Regexp.new(/^[A-Za-z0-9]{1,44}$/)
      true
    end
    ...
    def detail=(detail)
      if !detail.nil? && detail.to_s.length > 20
        fail ArgumentError, 'invalid value for "detail", the character length must be smaller than or equal to 20.'
      end
      ...
      pattern = Regexp.new(/^[A-Za-z0-9]{1,20}$/)
      if !detail.nil? && detail !~ pattern
        fail ArgumentError, "invalid value for \"detail\", must conform to the pattern #{pattern}."
      end
    ...
    def smart_contract_id=(smart_contract_id)
      if !smart_contract_id.nil? && smart_contract_id.to_s.length > 44
        fail ArgumentError, 'invalid value for "smart_contract_id", the character length must be smaller than or equal to 44.'
      end
    ...
    def hash
      [function, detail, type, smart_contract_id, extra_fields].hash
    end
