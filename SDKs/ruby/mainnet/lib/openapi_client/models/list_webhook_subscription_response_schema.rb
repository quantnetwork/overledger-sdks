...
module OpenapiClient
  class ListWebhookSubscriptionResponseSchema
    ...
    def self.openapi_types
      {
        :'subscription_details' => :'WebhookSubscriptionDetailsSchema',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ListWebhookSubscriptionResponseSchema` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ListWebhookSubscriptionResponseSchema`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'subscribed_time')
        self.subscribed_time = attributes[:'subscribed_time']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@subscription_id.nil? && @subscription_id.to_s.length < 0
      ...
      if !@type.nil? && @type.to_s.length > 24
        invalid_properties.push('invalid value for "type", the character length must be smaller than or equal to 24.')
      end
    ...
    def valid?
      ...
      return false if !@type.nil? && @type.to_s.length > 24
    ...
    def type=(type)
      if !type.nil? && type.to_s.length > 24
        fail ArgumentError, 'invalid value for "type", the character length must be smaller than or equal to 24.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          type == o.type &&
          subscribed_time == o.subscribed_time
    end
    ...
    def hash
      [subscription_details, last_updated_time, callback_url, subscription_id, type, subscribed_time].hash
    end
