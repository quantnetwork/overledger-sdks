  ...
  class TransferSchema
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::TransferSchema` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::TransferSchema`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@token_id.nil? && @token_id.to_s.length > 50
        invalid_properties.push('invalid value for "token_id", the character length must be smaller than or equal to 50.')
      end
      ...
      pattern = Regexp.new(/^[a-zA-Z0-9_ ]{1,50}$/)
      if !@token_id.nil? && @token_id !~ pattern
        invalid_properties.push("invalid value for \"token_id\", must conform to the pattern #{pattern}.")
      end

      if !@token_name.nil? && @token_name.to_s.length > 50
        invalid_properties.push('invalid value for "token_name", the character length must be smaller than or equal to 50.')
      end
    ...
    def valid?
      return false if !@token_id.nil? && @token_id.to_s.length > 50
      return false if !@token_id.nil? && @token_id.to_s.length < 0
      return false if !@token_id.nil? && @token_id !~ Regexp.new(/^[a-zA-Z0-9_ ]{1,50}$/)
      return false if !@token_name.nil? && @token_name.to_s.length > 50
      return false if !@token_name.nil? && @token_name.to_s.length < 0
      return false if !@token_name.nil? && @token_name !~ Regexp.new(/^[a-zA-Z0-9_ ]{1,50}$/)
      true
    end
    ...
    def token_id=(token_id)
      if !token_id.nil? && token_id.to_s.length > 50
        fail ArgumentError, 'invalid value for "token_id", the character length must be smaller than or equal to 50.'
      end
    ...
    def token_name=(token_name)
      if !token_name.nil? && token_name.to_s.length > 50
        fail ArgumentError, 'invalid value for "token_name", the character length must be smaller than or equal to 50.'
      end
