...
module OpenapiClient
  class TokenReadQRC721Response
    ...
    def self.openapi_types
      {
        :'token_name' => :'String',
        :'response_details' => :'TokenReadResponseDetails',
        :'location' => :'Location',
        :'request_id' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::TokenReadQRC721Response` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::TokenReadQRC721Response`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'response_details')
        self.response_details = attributes[:'response_details']
      end
    ...
    def hash
      [token_name, response_details, location, request_id].hash
    end
