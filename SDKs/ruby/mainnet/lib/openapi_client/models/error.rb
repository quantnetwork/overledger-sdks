...
module OpenapiClient
  class Error
    ...
    def list_invalid_properties
      ...
      if !@code.nil? && @code > 30
        invalid_properties.push('invalid value for "code", must be smaller than or equal to 30.')
      end
    ...
    def code=(code)
      if !code.nil? && code > 30
        fail ArgumentError, 'invalid value for "code", must be smaller than or equal to 30.'
      end
