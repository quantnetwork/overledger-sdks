...
module OpenapiClient
  class Pagination
    ...
    def list_invalid_properties
      ...
      if !@size.nil? && @size > 9
        invalid_properties.push('invalid value for "size", must be smaller than or equal to 9.')
      end
      ...
      if !@total.nil? && @total > 9
        invalid_properties.push('invalid value for "total", must be smaller than or equal to 9.')
      end
      ...
      if !@page.nil? && @page > 9
        invalid_properties.push('invalid value for "page", must be smaller than or equal to 9.')
      end
    ...
    def valid?
      return false if !@size.nil? && @size > 9
      return false if !@size.nil? && @size < 0
      return false if !@total.nil? && @total > 9
      return false if !@total.nil? && @total < 0
      return false if !@page.nil? && @page > 9
    ...
    def size=(size)
      if !size.nil? && size > 9
        fail ArgumentError, 'invalid value for "size", must be smaller than or equal to 9.'
      end
    ...
    def total=(total)
      if !total.nil? && total > 9
        fail ArgumentError, 'invalid value for "total", must be smaller than or equal to 9.'
      end
    ...
    def page=(page)
      if !page.nil? && page > 9
        fail ArgumentError, 'invalid value for "page", must be smaller than or equal to 9.'
      end
