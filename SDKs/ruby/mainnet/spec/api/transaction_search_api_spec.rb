...
# Unit tests for OpenapiClient::TransactionSearchApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'TransactionSearchApi' do
  before do
  ...
  describe 'test an instance of TransactionSearchApi' do
    it 'should create an instance of TransactionSearchApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::TransactionSearchApi)
    end
  end

  # unit tests for auto_execute_search_transaction_request
  ...
  describe 'auto_execute_search_transaction_request test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for execute_prepared_search_request_transaction
  ...
  describe 'execute_prepared_search_request_transaction test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for prepare_search_request
  ...
  describe 'prepare_search_request test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
