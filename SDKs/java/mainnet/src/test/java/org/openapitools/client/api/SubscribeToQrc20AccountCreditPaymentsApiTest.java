...
/**
 * API tests for SubscribeToQrc20AccountCreditPaymentsApi
 */
@Ignore
public class SubscribeToQrc20AccountCreditPaymentsApiTest {

    private final SubscribeToQrc20AccountCreditPaymentsApi api = new SubscribeToQrc20AccountCreditPaymentsApi();
     ...
     */
    @Test
    public void subscribeCreditEventTest() throws ApiException {
        String authorization = null;
        Object body = null;
                EventSubscriptionResponse response = api.subscribeCreditEvent(authorization, body);
