...
public class ApiClient {
    ...
    private String basePath = "https://api.sandbox.overledger.io";
    ...
    public ApiClient() {
        ...
        authentications.put("OAuth2_Security_Scheme", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://auth.overledger.io/oauth2/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.sandbox.overledger.io
