...
/**
 * API tests for RetrieveContractOwnerInformationOfAQrcTokenApi
 */
@Ignore
public class RetrieveContractOwnerInformationOfAQrcTokenApiTest {

    private final RetrieveContractOwnerInformationOfAQrcTokenApi api = new RetrieveContractOwnerInformationOfAQrcTokenApi();
     ...
     */
    @Test
    public void readQRCSmartContractOwnerTest() throws ApiException {
        String authorization = null;
        String flowType = null;
        PrepareRequest prepareRequest = null;
                TokenReadQRC721Response response = api.readQRCSmartContractOwner(authorization, flowType, prepareRequest);
