...
/**
 * API tests for RetrieveApprovedAccountInformationForAQrc20TokenApi
 */
@Ignore
public class RetrieveApprovedAccountInformationForAQrc20TokenApiTest {

    private final RetrieveApprovedAccountInformationForAQrc20TokenApi api = new RetrieveApprovedAccountInformationForAQrc20TokenApi();
     ...
     */
    @Test
    public void readQRC20SecondaryAccountOwnerTest() throws ApiException {
        String authorization = null;
        ReadContractOwnerRequestSchema readContractOwnerRequestSchema = null;
                TokenReadQRC20Response response = api.readQRC20SecondaryAccountOwner(authorization, readContractOwnerRequestSchema);
