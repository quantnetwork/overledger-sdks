...
// PrepareBurnTransactionRequestSchema struct for PrepareBurnTransactionRequestSchema
type PrepareBurnTransactionRequestSchema struct {
	...
	RequestDetails *BurnRequestDetailsSchema `json:"requestDetails,omitempty"`
}
...
func NewPrepareBurnTransactionRequestSchema(location Location, type_ string, urgency string) *PrepareBurnTransactionRequestSchema {
	this := PrepareBurnTransactionRequestSchema{}
...
func (o *PrepareBurnTransactionRequestSchema) GetRequestDetails() BurnRequestDetailsSchema {
	if o == nil || o.RequestDetails == nil {
		var ret BurnRequestDetailsSchema
		return ret
	}
...
// SetRequestDetails gets a reference to the given BurnRequestDetailsSchema and assigns it to the RequestDetails field.
func (o *PrepareBurnTransactionRequestSchema) SetRequestDetails(v BurnRequestDetailsSchema) {
	o.RequestDetails = &v
}

func (o PrepareBurnTransactionRequestSchema) MarshalJSON() ([]byte, error) {
...
type NullablePrepareBurnTransactionRequestSchema struct {
	value *PrepareBurnTransactionRequestSchema
	isSet bool
}

func (v NullablePrepareBurnTransactionRequestSchema) Get() *PrepareBurnTransactionRequestSchema {
	return v.value
}

func (v *NullablePrepareBurnTransactionRequestSchema) Set(val *PrepareBurnTransactionRequestSchema) {
	v.value = val
	v.isSet = true
}

func (v NullablePrepareBurnTransactionRequestSchema) IsSet() bool {
	return v.isSet
}

func (v *NullablePrepareBurnTransactionRequestSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrepareBurnTransactionRequestSchema(val *PrepareBurnTransactionRequestSchema) *NullablePrepareBurnTransactionRequestSchema {
	return &NullablePrepareBurnTransactionRequestSchema{value: val, isSet: true}
}

func (v NullablePrepareBurnTransactionRequestSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrepareBurnTransactionRequestSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
