...
// ReadApprovedAccountAllowanceRequestSchema struct for ReadApprovedAccountAllowanceRequestSchema
type ReadApprovedAccountAllowanceRequestSchema struct {
...
func NewReadApprovedAccountAllowanceRequestSchema() *ReadApprovedAccountAllowanceRequestSchema {
	this := ReadApprovedAccountAllowanceRequestSchema{}
	return &this
}
...
func (o ReadApprovedAccountAllowanceRequestSchema) MarshalJSON() ([]byte, error) {
...
type NullableReadApprovedAccountAllowanceRequestSchema struct {
	value *ReadApprovedAccountAllowanceRequestSchema
	isSet bool
}

func (v NullableReadApprovedAccountAllowanceRequestSchema) Get() *ReadApprovedAccountAllowanceRequestSchema {
	return v.value
}

func (v *NullableReadApprovedAccountAllowanceRequestSchema) Set(val *ReadApprovedAccountAllowanceRequestSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableReadApprovedAccountAllowanceRequestSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableReadApprovedAccountAllowanceRequestSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReadApprovedAccountAllowanceRequestSchema(val *ReadApprovedAccountAllowanceRequestSchema) *NullableReadApprovedAccountAllowanceRequestSchema {
	return &NullableReadApprovedAccountAllowanceRequestSchema{value: val, isSet: true}
}

func (v NullableReadApprovedAccountAllowanceRequestSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReadApprovedAccountAllowanceRequestSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
