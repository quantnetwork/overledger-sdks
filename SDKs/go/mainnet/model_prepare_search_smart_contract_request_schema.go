...
// PrepareSearchSmartContractRequestSchema struct for PrepareSearchSmartContractRequestSchema
type PrepareSearchSmartContractRequestSchema struct {
	RequestDetails *SmartContractSearchRequestDetails `json:"requestDetails,omitempty"`
...
func NewPrepareSearchSmartContractRequestSchema() *PrepareSearchSmartContractRequestSchema {
	this := PrepareSearchSmartContractRequestSchema{}
	return &this
}
...
func (o *PrepareSearchSmartContractRequestSchema) GetRequestDetails() SmartContractSearchRequestDetails {
	if o == nil || o.RequestDetails == nil {
		var ret SmartContractSearchRequestDetails
		return ret
	}
...
// SetRequestDetails gets a reference to the given SmartContractSearchRequestDetails and assigns it to the RequestDetails field.
...
func (o PrepareSearchSmartContractRequestSchema) MarshalJSON() ([]byte, error) {
...
type NullablePrepareSearchSmartContractRequestSchema struct {
	value *PrepareSearchSmartContractRequestSchema
	isSet bool
}

func (v NullablePrepareSearchSmartContractRequestSchema) Get() *PrepareSearchSmartContractRequestSchema {
	return v.value
}

func (v *NullablePrepareSearchSmartContractRequestSchema) Set(val *PrepareSearchSmartContractRequestSchema) {
	v.value = val
	v.isSet = true
}

func (v NullablePrepareSearchSmartContractRequestSchema) IsSet() bool {
	return v.isSet
}

func (v *NullablePrepareSearchSmartContractRequestSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrepareSearchSmartContractRequestSchema(val *PrepareSearchSmartContractRequestSchema) *NullablePrepareSearchSmartContractRequestSchema {
	return &NullablePrepareSearchSmartContractRequestSchema{value: val, isSet: true}
}

func (v NullablePrepareSearchSmartContractRequestSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrepareSearchSmartContractRequestSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
