...
// CreateAQRC721TransferTransactionApiService CreateAQRC721TransferTransactionApi service
type CreateAQRC721TransferTransactionApiService service

type ApiPrepareTransactionRequestRequest struct {
	ctx _context.Context
	ApiService *CreateAQRC721TransferTransactionApiService
...
/*
PrepareTransactionRequest Prepare a QRC721 token transfer transaction for signing
...
*/
func (a *CreateAQRC721TransferTransactionApiService) PrepareTransactionRequest(ctx _context.Context) ApiPrepareTransactionRequestRequest {
	return ApiPrepareTransactionRequestRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CreateAQRC721TransferTransactionApiService) PrepareTransactionRequestExecute(r ApiPrepareTransactionRequestRequest) (PrepareTransactionResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CreateAQRC721TransferTransactionApiService.PrepareTransactionRequest")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/tokenise/preparation/transaction/qrc721/transfer"
