...
type ApiAutoExecuteSearchBlockRequestRequest struct {
...
func (r ApiAutoExecuteSearchBlockRequestRequest) Authorization(authorization string) ApiAutoExecuteSearchBlockRequestRequest {
	r.authorization = &authorization
	return r
}
func (r ApiAutoExecuteSearchBlockRequestRequest) PrepareSearchSchema(prepareSearchSchema PrepareSearchSchema) ApiAutoExecuteSearchBlockRequestRequest {
	r.prepareSearchSchema = &prepareSearchSchema
	return r
}

func (r ApiAutoExecuteSearchBlockRequestRequest) Execute() (AutoExecuteSearchBlockResponseSchema, *_nethttp.Response, error) {
	return r.ApiService.AutoExecuteSearchBlockRequestExecute(r)
}

/*
AutoExecuteSearchBlockRequest Prepare and automatically execute a search for a block on a DLT.

Generates a request ID and automatically executes the block search on the requested DLT.

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param blockId
 @return ApiAutoExecuteSearchBlockRequestRequest
*/
func (a *BlockSearchApiService) AutoExecuteSearchBlockRequest(ctx _context.Context, blockId string) ApiAutoExecuteSearchBlockRequestRequest {
	return ApiAutoExecuteSearchBlockRequestRequest{
		ApiService: a,
		ctx: ctx,
		blockId: blockId,
...
func (a *BlockSearchApiService) AutoExecuteSearchBlockRequestExecute(r ApiAutoExecuteSearchBlockRequestRequest) (AutoExecuteSearchBlockResponseSchema, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  AutoExecuteSearchBlockResponseSchema
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BlockSearchApiService.AutoExecuteSearchBlockRequest")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/autoexecution/search/block/{blockId}"
