...
type NullableAddressMonitoringResponseSchema struct {
	value *AddressMonitoringResponseSchema
	isSet bool
}

func (v NullableAddressMonitoringResponseSchema) Get() *AddressMonitoringResponseSchema {
	return v.value
}

func (v *NullableAddressMonitoringResponseSchema) Set(val *AddressMonitoringResponseSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressMonitoringResponseSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressMonitoringResponseSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressMonitoringResponseSchema(val *AddressMonitoringResponseSchema) *NullableAddressMonitoringResponseSchema {
	return &NullableAddressMonitoringResponseSchema{value: val, isSet: true}
}

func (v NullableAddressMonitoringResponseSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressMonitoringResponseSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
