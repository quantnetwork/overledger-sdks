...
type ApiAutoExecuteSearchSmartContractQueryRequestRequest struct {
...
func (r ApiAutoExecuteSearchSmartContractQueryRequestRequest) Authorization(authorization string) ApiAutoExecuteSearchSmartContractQueryRequestRequest {
	r.authorization = &authorization
	return r
}
func (r ApiAutoExecuteSearchSmartContractQueryRequestRequest) PrepareSearchSchema(prepareSearchSchema PrepareSearchSchema) ApiAutoExecuteSearchSmartContractQueryRequestRequest {
	r.prepareSearchSchema = &prepareSearchSchema
	return r
}

func (r ApiAutoExecuteSearchSmartContractQueryRequestRequest) Execute() (AutoExecuteSearchAddressBalanceResponseSchema, *_nethttp.Response, error) {
	return r.ApiService.AutoExecuteSearchSmartContractQueryRequestExecute(r)
}

/*
AutoExecuteSearchSmartContractQueryRequest Prepare and automatically execute a search for a smart contract query on a DLT.
...
Generates a request ID and automatically executes the smart contract query search on the requested DLT.
 ...
 @return ApiAutoExecuteSearchSmartContractQueryRequestRequest
*/
func (a *SmartContractSearchApiService) AutoExecuteSearchSmartContractQueryRequest(ctx _context.Context) ApiAutoExecuteSearchSmartContractQueryRequestRequest {
	return ApiAutoExecuteSearchSmartContractQueryRequestRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SmartContractSearchApiService) AutoExecuteSearchSmartContractQueryRequestExecute(r ApiAutoExecuteSearchSmartContractQueryRequestRequest) (AutoExecuteSearchAddressBalanceResponseSchema, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SmartContractSearchApiService.AutoExecuteSearchSmartContractQueryRequest")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/autoexecution/search/smartcontract"
