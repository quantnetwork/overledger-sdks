...
import org.openapitools.client.models.ApproveRequestDetailsSchema
...
data class PrepareApproveDebitTransactionRequestSchema (
    ...
    @Json(name = "type")
    val type: PrepareApproveDebitTransactionRequestSchema.Type,
    ...
    @Json(name = "urgency")
    val urgency: PrepareApproveDebitTransactionRequestSchema.Urgency,

    @Json(name = "requestDetails")
    val requestDetails: ApproveRequestDetailsSchema? = null
