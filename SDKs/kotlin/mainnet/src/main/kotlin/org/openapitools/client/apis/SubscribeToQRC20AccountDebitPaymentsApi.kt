...
class SubscribeToQRC20AccountDebitPaymentsApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun subscribeQRC20DebitEvent(authorization: kotlin.String, body: kotlin.Any) : EventSubscriptionResponse {
        val localVariableConfig = subscribeQRC20DebitEventRequestConfig(authorization = authorization, body = body)
    ...
    /**
    * To obtain the request config of the operation subscribeQRC20DebitEvent
    *
    * @param authorization  
    * @param body  
    * @return RequestConfig
    */
    fun subscribeQRC20DebitEventRequestConfig(authorization: kotlin.String, body: kotlin.Any) : RequestConfig<kotlin.Any> {
        ...
        return RequestConfig(
            ...
            path = "/v2/tokenise/tokens/subscription/qrc20/debit",
