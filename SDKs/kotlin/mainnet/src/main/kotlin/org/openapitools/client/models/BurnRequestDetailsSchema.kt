...
import org.openapitools.client.models.OwnerBurnSchema
 ...
 * 
 *
 * @param owner Who is the owner of the tokens
 * @param message Any text-based element of the data payload
 * @param overledgerSigningType 
 */

data class BurnRequestDetailsSchema (

    /* Who is the owner of the tokens */
    @Json(name = "owner")
    val owner: kotlin.collections.List<OwnerBurnSchema>? = null,
