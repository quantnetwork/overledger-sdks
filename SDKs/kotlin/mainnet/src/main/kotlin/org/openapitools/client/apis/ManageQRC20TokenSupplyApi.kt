...
import org.openapitools.client.models.PrepareMintTransactionRequestSchemaQrc20
...
class ManageQRC20TokenSupplyApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    * @param authorization  
    * @param prepareMintTransactionRequestSchemaQrc20  
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun prepareSupplyRequest1(authorization: kotlin.String, prepareMintTransactionRequestSchemaQrc20: PrepareMintTransactionRequestSchemaQrc20) : PrepareTransactionResponse {
        val localVariableConfig = prepareSupplyRequest1RequestConfig(authorization = authorization, prepareMintTransactionRequestSchemaQrc20 = prepareMintTransactionRequestSchemaQrc20)

        val localVarResponse = request<PrepareMintTransactionRequestSchemaQrc20, PrepareTransactionResponse>(
            localVariableConfig
        )
    ...
    /**
    * To obtain the request config of the operation prepareSupplyRequest1
    *
    * @param authorization  
    * @param prepareMintTransactionRequestSchemaQrc20  
    * @return RequestConfig
    */
    fun prepareSupplyRequest1RequestConfig(authorization: kotlin.String, prepareMintTransactionRequestSchemaQrc20: PrepareMintTransactionRequestSchemaQrc20) : RequestConfig<PrepareMintTransactionRequestSchemaQrc20> {
        val localVariableBody = prepareMintTransactionRequestSchemaQrc20
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        authorization.apply { localVariableHeaders["Authorization"] = this.toString() }
