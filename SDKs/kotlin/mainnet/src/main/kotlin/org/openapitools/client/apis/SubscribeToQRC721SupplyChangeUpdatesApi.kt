...
class SubscribeToQRC721SupplyChangeUpdatesApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun subscribeSupplyEvent(authorization: kotlin.String, flowtype: kotlin.String, body: kotlin.Any) : EventSubscriptionResponse {
        val localVariableConfig = subscribeSupplyEventRequestConfig(authorization = authorization, flowtype = flowtype, body = body)
    ...
    /**
    * To obtain the request config of the operation subscribeSupplyEvent
    *
    * @param authorization  
    * @param flowtype  
    * @param body  
    ...
    */
    fun subscribeSupplyEventRequestConfig(authorization: kotlin.String, flowtype: kotlin.String, body: kotlin.Any) : RequestConfig<kotlin.Any> {
        ...
        return RequestConfig(
            ...
            path = "/v2/tokenise/tokens/subscription/{flowtype}/supply".replace("{"+"flowtype"+"}", "$flowtype"),
