...
class CreateAQRC20DebitTransactionApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun prepareDebitRequest(authorization: kotlin.String, prepareCreditTransactionRequestSchema: PrepareCreditTransactionRequestSchema) : PrepareTransactionResponse {
        val localVariableConfig = prepareDebitRequestRequestConfig(authorization = authorization, prepareCreditTransactionRequestSchema = prepareCreditTransactionRequestSchema)
    ...
    /**
    * To obtain the request config of the operation prepareDebitRequest
    *
    * @param authorization  
    * @param prepareCreditTransactionRequestSchema  
    * @return RequestConfig
    */
    fun prepareDebitRequestRequestConfig(authorization: kotlin.String, prepareCreditTransactionRequestSchema: PrepareCreditTransactionRequestSchema) : RequestConfig<PrepareCreditTransactionRequestSchema> {
