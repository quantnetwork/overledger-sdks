...
import org.openapitools.client.models.PrepareAndExecuteTransactionResponse
...
class TransactionSearchApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun autoExecuteSearchTransactionRequest(authorization: kotlin.String, transactionId: kotlin.String, prepareSearchSchema: PrepareSearchSchema) : PrepareAndExecuteTransactionResponse {
        val localVariableConfig = autoExecuteSearchTransactionRequestRequestConfig(authorization = authorization, transactionId = transactionId, prepareSearchSchema = prepareSearchSchema)

        val localVarResponse = request<PrepareSearchSchema, PrepareAndExecuteTransactionResponse>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as PrepareAndExecuteTransactionResponse
    ...
    */
    fun autoExecuteSearchTransactionRequestRequestConfig(authorization: kotlin.String, transactionId: kotlin.String, prepareSearchSchema: PrepareSearchSchema) : RequestConfig<PrepareSearchSchema> {
        ...
        return RequestConfig(
            ...
            path = "/v2/autoexecution/search/transaction",
