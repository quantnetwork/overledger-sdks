...
class SubscribeToQRC721AssetCollectionUpdatesApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun subscribeCollectEvent(authorization: kotlin.String, body: kotlin.Any) : EventSubscriptionResponse {
        val localVariableConfig = subscribeCollectEventRequestConfig(authorization = authorization, body = body)
    ...
    /**
    * To obtain the request config of the operation subscribeCollectEvent
    *
    * @param authorization  
    * @param body  
    * @return RequestConfig
    */
    fun subscribeCollectEventRequestConfig(authorization: kotlin.String, body: kotlin.Any) : RequestConfig<kotlin.Any> {
        ...
        return RequestConfig(
            ...
            path = "/v2/tokenise/tokens/subscription/qrc721/collect",
