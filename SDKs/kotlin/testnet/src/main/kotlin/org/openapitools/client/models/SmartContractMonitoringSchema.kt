 ...
 * 
 *
 * @param smartContractEventMonitoringDetails 
 * @param resourceMonitoring 
 */

data class SmartContractMonitoringSchema (

    @Json(name = "smartContractEventMonitoringDetails")
    val smartContractEventMonitoringDetails: ResourceMonitoringSmartContractEventDetails? = null,
