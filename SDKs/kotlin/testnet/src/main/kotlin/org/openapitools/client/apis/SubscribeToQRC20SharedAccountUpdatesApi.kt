...
class SubscribeToQRC20SharedAccountUpdatesApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun subscribeSecondaryOwnerEvent(authorization: kotlin.String, body: kotlin.Any) : EventSubscriptionResponse {
        val localVariableConfig = subscribeSecondaryOwnerEventRequestConfig(authorization = authorization, body = body)
    ...
    /**
    * To obtain the request config of the operation subscribeSecondaryOwnerEvent
    *
    * @param authorization  
    * @param body  
    * @return RequestConfig
    */
    fun subscribeSecondaryOwnerEventRequestConfig(authorization: kotlin.String, body: kotlin.Any) : RequestConfig<kotlin.Any> {
        ...
        return RequestConfig(
            ...
            path = "/v2/tokenise/tokens/subscription/qrc20/secondaryaccountowner",
