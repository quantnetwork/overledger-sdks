...
import org.openapitools.client.models.BurnRequestDetailsSchema
...
data class PrepareBurnTransactionRequestSchema (
    ...
    @Json(name = "type")
    val type: PrepareBurnTransactionRequestSchema.Type,
    ...
    @Json(name = "urgency")
    val urgency: PrepareBurnTransactionRequestSchema.Urgency,

    @Json(name = "requestDetails")
    val requestDetails: BurnRequestDetailsSchema? = null
