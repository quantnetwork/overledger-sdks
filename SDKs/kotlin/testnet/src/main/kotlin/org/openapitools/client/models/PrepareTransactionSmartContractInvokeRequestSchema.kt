...
import org.openapitools.client.models.SmartContractInvokeRequestDetailsSchema
...
data class PrepareTransactionSmartContractInvokeRequestSchema (
    ...
    @Json(name = "type")
    val type: PrepareTransactionSmartContractInvokeRequestSchema.Type,
    ...
    @Json(name = "urgency")
    val urgency: PrepareTransactionSmartContractInvokeRequestSchema.Urgency,

    @Json(name = "requestDetails")
    val requestDetails: SmartContractInvokeRequestDetailsSchema? = null
