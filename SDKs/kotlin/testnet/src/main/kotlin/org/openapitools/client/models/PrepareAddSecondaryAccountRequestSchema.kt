...
import org.openapitools.client.models.AddSecondaryAccountRequestDetailsSchema
...
data class PrepareAddSecondaryAccountRequestSchema (
    ...
    @Json(name = "type")
    val type: PrepareAddSecondaryAccountRequestSchema.Type,
    ...
    @Json(name = "urgency")
    val urgency: PrepareAddSecondaryAccountRequestSchema.Urgency,

    @Json(name = "requestDetails")
    val requestDetails: AddSecondaryAccountRequestDetailsSchema? = null
