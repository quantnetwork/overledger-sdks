...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.PreparePaymentTransactionRequestSchema();
  });
  ...
  describe('PreparePaymentTransactionRequestSchema', function() {
    it('should create an instance of PreparePaymentTransactionRequestSchema', function() {
      // uncomment below and update the code to test PreparePaymentTransactionRequestSchema
