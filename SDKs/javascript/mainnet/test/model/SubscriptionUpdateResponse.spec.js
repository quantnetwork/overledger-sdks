...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.SubscriptionUpdateResponse();
  });
  ...
  describe('SubscriptionUpdateResponse', function() {
    it('should create an instance of SubscriptionUpdateResponse', function() {
      // uncomment below and update the code to test SubscriptionUpdateResponse
      //var instance = new QuantOverledgerApi.SubscriptionUpdateResponse();
      //expect(instance).to.be.a(QuantOverledgerApi.SubscriptionUpdateResponse);
    });
