...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.SmartContractReadSchema();
  });
  ...
  describe('SmartContractReadSchema', function() {
    it('should create an instance of SmartContractReadSchema', function() {
      // uncomment below and update the code to test SmartContractReadSchema
      //var instance = new QuantOverledgerApi.SmartContractReadSchema();
      //expect(instance).to.be.a(QuantOverledgerApi.SmartContractReadSchema);
    });
