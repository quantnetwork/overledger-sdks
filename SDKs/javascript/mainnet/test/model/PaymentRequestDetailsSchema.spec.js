...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.PaymentRequestDetailsSchema();
  });
  ...
  describe('PaymentRequestDetailsSchema', function() {
    it('should create an instance of PaymentRequestDetailsSchema', function() {
      // uncomment below and update the code to test PaymentRequestDetailsSchema
      //var instance = new QuantOverledgerApi.PaymentRequestDetailsSchema();
      //expect(instance).to.be.a(QuantOverledgerApi.PaymentRequestDetailsSchema);
    });
