...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.SmartContractTag();
  });
  ...
  describe('SmartContractTag', function() {
    it('should create an instance of SmartContractTag', function() {
      // uncomment below and update the code to test SmartContractTag
      //var instance = new QuantOverledgerApi.SmartContractTag();
      //expect(instance).to.be.a(QuantOverledgerApi.SmartContractTag);
    });
