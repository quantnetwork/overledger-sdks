...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.SmartContractReadFunctionSchema();
  });
  ...
  describe('SmartContractReadFunctionSchema', function() {
    it('should create an instance of SmartContractReadFunctionSchema', function() {
      // uncomment below and update the code to test SmartContractReadFunctionSchema
      //var instance = new QuantOverledgerApi.SmartContractReadFunctionSchema();
      //expect(instance).to.be.a(QuantOverledgerApi.SmartContractReadFunctionSchema);
    });
