...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.PrepareAndExecuteTransactionResponse();
  });
  ...
  describe('PrepareAndExecuteTransactionResponse', function() {
    it('should create an instance of PrepareAndExecuteTransactionResponse', function() {
      // uncomment below and update the code to test PrepareAndExecuteTransactionResponse
