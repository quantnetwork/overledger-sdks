...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.TransferSchema();
  });
  ...
  describe('TransferSchema', function() {
    it('should create an instance of TransferSchema', function() {
      // uncomment below and update the code to test TransferSchema
      //var instance = new QuantOverledgerApi.TransferSchema();
      //expect(instance).to.be.a(QuantOverledgerApi.TransferSchema);
    });
