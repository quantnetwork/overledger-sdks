...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.MintRequestDetailsSchemaQrc20();
  });
  ...
  describe('MintRequestDetailsSchemaQrc20', function() {
    it('should create an instance of MintRequestDetailsSchemaQrc20', function() {
      // uncomment below and update the code to test MintRequestDetailsSchemaQrc20
      //var instance = new QuantOverledgerApi.MintRequestDetailsSchemaQrc20();
      //expect(instance).to.be.a(QuantOverledgerApi.MintRequestDetailsSchemaQrc20);
    });
