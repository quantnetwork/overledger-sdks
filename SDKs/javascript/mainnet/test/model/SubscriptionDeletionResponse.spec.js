...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.SubscriptionDeletionResponse();
  });
  ...
  describe('SubscriptionDeletionResponse', function() {
    it('should create an instance of SubscriptionDeletionResponse', function() {
      // uncomment below and update the code to test SubscriptionDeletionResponse
      //var instance = new QuantOverledgerApi.SubscriptionDeletionResponse();
      //expect(instance).to.be.a(QuantOverledgerApi.SubscriptionDeletionResponse);
    });
