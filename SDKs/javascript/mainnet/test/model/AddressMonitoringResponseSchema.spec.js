...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.AddressMonitoringResponseSchema();
  });
  ...
  describe('AddressMonitoringResponseSchema', function() {
    it('should create an instance of AddressMonitoringResponseSchema', function() {
      // uncomment below and update the code to test AddressMonitoringResponseSchema
      //var instance = new QuantOverledgerApi.AddressMonitoringResponseSchema();
      //expect(instance).to.be.a(QuantOverledgerApi.AddressMonitoringResponseSchema);
    });
