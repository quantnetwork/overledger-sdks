...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.UTXOSmartContract();
  });
  ...
  describe('UTXOSmartContract', function() {
    it('should create an instance of UTXOSmartContract', function() {
      // uncomment below and update the code to test UTXOSmartContract
      //var instance = new QuantOverledgerApi.UTXOSmartContract();
      //expect(instance).to.be.a(QuantOverledgerApi.UTXOSmartContract);
    });
