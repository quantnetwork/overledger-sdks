...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.ResourceMonitoringAddressSchema();
  });
  ...
  describe('ResourceMonitoringAddressSchema', function() {
    it('should create an instance of ResourceMonitoringAddressSchema', function() {
      // uncomment below and update the code to test ResourceMonitoringAddressSchema
      //var instance = new QuantOverledgerApi.ResourceMonitoringAddressSchema();
      //expect(instance).to.be.a(QuantOverledgerApi.ResourceMonitoringAddressSchema);
    });
