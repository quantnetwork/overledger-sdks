...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.CreateSmartContractMonitoringSchema();
  });
  ...
  describe('CreateSmartContractMonitoringSchema', function() {
    it('should create an instance of CreateSmartContractMonitoringSchema', function() {
      // uncomment below and update the code to test CreateSmartContractMonitoringSchema
      //var instance = new QuantOverledgerApi.CreateSmartContractMonitoringSchema();
      //expect(instance).to.be.a(QuantOverledgerApi.CreateSmartContractMonitoringSchema);
    });
