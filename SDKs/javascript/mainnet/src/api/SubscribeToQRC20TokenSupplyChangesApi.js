...
/**
* SubscribeToQRC20TokenSupplyChanges service.
* @module api/SubscribeToQRC20TokenSupplyChangesApi
* @version 2.0
*/
export default class SubscribeToQRC20TokenSupplyChangesApi {

    /**
    * Constructs a new SubscribeToQRC20TokenSupplyChangesApi. 
    * @alias module:api/SubscribeToQRC20TokenSupplyChangesApi
    * @class
    ...
    */
     ...
     * @callback module:api/SubscribeToQRC20TokenSupplyChangesApi~subscribeSupplyEventCallback
     ...
     * @param {module:api/SubscribeToQRC20TokenSupplyChangesApi~subscribeSupplyEventCallback} callback The callback function, accepting three arguments: error, data, response
