...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.EventSubscriptionResponse();
  });
  ...
  describe('EventSubscriptionResponse', function() {
    it('should create an instance of EventSubscriptionResponse', function() {
      ...
      //var instance = new QuantOverledgerApi.EventSubscriptionResponse();
      //expect(instance).to.be.a(QuantOverledgerApi.EventSubscriptionResponse);
    });
