...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.TierFunctionDTO();
  });
  ...
  describe('TierFunctionDTO', function() {
    it('should create an instance of TierFunctionDTO', function() {
      // uncomment below and update the code to test TierFunctionDTO
      //var instance = new QuantOverledgerApi.TierFunctionDTO();
      //expect(instance).to.be.a(QuantOverledgerApi.TierFunctionDTO);
    });
