...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.Vout();
  });
  ...
  describe('Vout', function() {
    it('should create an instance of Vout', function() {
      // uncomment below and update the code to test Vout
      //var instance = new QuantOverledgerApi.Vout();
      //expect(instance).to.be.a(QuantOverledgerApi.Vout);
    });
