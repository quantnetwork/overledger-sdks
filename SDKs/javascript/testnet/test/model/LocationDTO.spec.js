...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.LocationDTO();
  });
  ...
  describe('LocationDTO', function() {
    it('should create an instance of LocationDTO', function() {
      // uncomment below and update the code to test LocationDTO
      //var instance = new QuantOverledgerApi.LocationDTO();
      //expect(instance).to.be.a(QuantOverledgerApi.LocationDTO);
    });
