...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.ApproveRequestDetailsSchema();
  });
  ...
  describe('ApproveRequestDetailsSchema', function() {
    it('should create an instance of ApproveRequestDetailsSchema', function() {
      // uncomment below and update the code to test ApproveRequestDetailsSchema
      //var instance = new QuantOverledgerApi.ApproveRequestDetailsSchema();
      //expect(instance).to.be.a(QuantOverledgerApi.ApproveRequestDetailsSchema);
    });
