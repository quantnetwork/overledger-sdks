...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QuantOverledgerApi.AccountDetails();
  });
  ...
  describe('AccountDetails', function() {
    it('should create an instance of AccountDetails', function() {
      ...
      //var instance = new QuantOverledgerApi.AccountDetails();
      //expect(instance).to.be.a(QuantOverledgerApi.AccountDetails);
    });
    ...
    it('should have the property owningInstitutionId (base name: "owningInstitutionId")', function() {
      // uncomment below and update the code to test the property owningInstitutionId
      //var instance = new QuantOverledgerApi.AccountDetails();
      //expect(instance).to.be();
    });
