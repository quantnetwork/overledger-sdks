...
export default class CreateAQRC20DebitTransactionApi {
    ...
    */
     ...
     * @callback module:api/CreateAQRC20DebitTransactionApi~executePreparedRequestTransactionCallback
     ...
     * @param {module:api/CreateAQRC20DebitTransactionApi~executePreparedRequestTransactionCallback} callback The callback function, accepting three arguments: error, data, response
