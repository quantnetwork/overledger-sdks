...
module QuantOverledger.API.CreateAQRC721TransferTransaction where
...
-- ** CreateAQRC721TransferTransaction
...
prepareTransactionRequest preparePaymentTransactionRequestSchema (Authorization authorization) =
  _mkRequest "POST" ["/v2/tokenise/preparation/transaction/qrc721/transfer"]
