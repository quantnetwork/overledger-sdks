...
module QuantOverledger.API.SubscribeToQRC721AssetCollectionUpdates where
...
-- ** SubscribeToQRC721AssetCollectionUpdates

-- *** subscribeCollectEvent

-- | @POST \/v2\/tokenise\/tokens\/subscription\/qrc721\/collect@
-- 
...
-- 
subscribeCollectEvent
  :: (Consumes SubscribeCollectEvent MimeJSON, MimeRender MimeJSON Body)
  => Body -- ^ "body"
  -> Authorization -- ^ "authorization"
  -> QuantOverledgerRequest SubscribeCollectEvent MimeJSON EventSubscriptionResponse MimeJSON
subscribeCollectEvent body (Authorization authorization) =
  _mkRequest "POST" ["/v2/tokenise/tokens/subscription/qrc721/collect"]
    `setBodyParam` body
    `addHeader` toHeader ("Authorization", authorization)

data SubscribeCollectEvent 
instance HasBodyParam SubscribeCollectEvent Body 

-- | @application/json@
instance Consumes SubscribeCollectEvent MimeJSON

-- | @application/json@
instance Produces SubscribeCollectEvent MimeJSON
