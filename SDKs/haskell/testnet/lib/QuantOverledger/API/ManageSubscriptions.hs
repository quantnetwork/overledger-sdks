...
module QuantOverledger.API.ManageSubscriptions where
...
deleteSubscription
  ...
  -> QuantOverledgerRequest DeleteSubscription MimeNoContent WebhookSubscriptionStatusUpdateResponse MimeJSON
...
listSubscriptions
  :: Authorization -- ^ "authorization"
  -> QuantOverledgerRequest ListSubscriptions MimeNoContent [ListWebhookSubscriptionResponseSchema] MimeJSON
...
-- 
updateSubscription
  :: (Consumes UpdateSubscription MimeJSON, MimeRender MimeJSON UpdateWebhookSubscriptionRequestSchema)
  => UpdateWebhookSubscriptionRequestSchema -- ^ "updateWebhookSubscriptionRequestSchema"
  -> Authorization -- ^ "authorization"
  -> SubscriptionId -- ^ "subscriptionId"
  -> QuantOverledgerRequest UpdateSubscription MimeJSON WebhookSubscriptionStatusUpdateResponse MimeJSON
updateSubscription updateWebhookSubscriptionRequestSchema (Authorization authorization) (SubscriptionId subscriptionId) =
  _mkRequest "PATCH" ["/v2/webhook/subscription/",toPath subscriptionId]
    `_hasAuthType` (P.Proxy :: P.Proxy AuthOAuthOAuth2SecurityScheme)
    `setBodyParam` updateWebhookSubscriptionRequestSchema
    `addHeader` toHeader ("Authorization", authorization)

data UpdateSubscription 
instance HasBodyParam UpdateSubscription UpdateWebhookSubscriptionRequestSchema 
