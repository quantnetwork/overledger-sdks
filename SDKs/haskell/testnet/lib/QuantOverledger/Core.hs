...
module QuantOverledger.Core where
...
-- * QuantOverledgerConfig

-- |
data QuantOverledgerConfig = QuantOverledgerConfig
...
-- | display the config
instance P.Show QuantOverledgerConfig where
  show c =
    T.printf
...
-- | constructs a default QuantOverledgerConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"quant-overledger/0.1.0.0"@
--
newConfig :: IO QuantOverledgerConfig
newConfig = do
    logCxt <- initLogContext
    return $ QuantOverledgerConfig
        { configHost = "https://api.sandbox.overledger.io"
        , configUserAgent = "quant-overledger/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => QuantOverledgerConfig -> auth -> QuantOverledgerConfig
addAuthMethod config@QuantOverledgerConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: QuantOverledgerConfig -> IO QuantOverledgerConfig
...
withStderrLogging :: QuantOverledgerConfig -> IO QuantOverledgerConfig
...
withNoLogging :: QuantOverledgerConfig -> QuantOverledgerConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * QuantOverledgerRequest
...
data QuantOverledgerRequest req contentType res accept = QuantOverledgerRequest
  { rMethod  :: NH.Method   -- ^ Method of QuantOverledgerRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of QuantOverledgerRequest
  , rParams   :: Params -- ^ params of QuantOverledgerRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (QuantOverledgerRequest req contentType res accept) NH.Method
rMethodL f QuantOverledgerRequest{..} = (\rMethod -> QuantOverledgerRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (QuantOverledgerRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f QuantOverledgerRequest{..} = (\rUrlPath -> QuantOverledgerRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (QuantOverledgerRequest req contentType res accept) Params
rParamsL f QuantOverledgerRequest{..} = (\rParams -> QuantOverledgerRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (QuantOverledgerRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f QuantOverledgerRequest{..} = (\rAuthTypes -> QuantOverledgerRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => QuantOverledgerRequest req contentType res accept -> param -> QuantOverledgerRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: QuantOverledgerRequest req contentType res accept -> param -> QuantOverledgerRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: QuantOverledgerRequest req contentType res accept -> param -> QuantOverledgerRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** QuantOverledgerRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> QuantOverledgerRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = QuantOverledgerRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     QuantOverledgerRequest req contentType res accept
  -> [NH.Header]
  -> QuantOverledgerRequest req contentType res accept
...
removeHeader :: QuantOverledgerRequest req contentType res accept -> [NH.HeaderName] -> QuantOverledgerRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => QuantOverledgerRequest req contentType res accept -> QuantOverledgerRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => QuantOverledgerRequest req contentType res accept -> QuantOverledgerRequest req contentType res accept
...
addForm :: QuantOverledgerRequest req contentType res accept -> WH.Form -> QuantOverledgerRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: QuantOverledgerRequest req contentType res accept -> NH.Part -> QuantOverledgerRequest req contentType res accept
...
_setBodyBS :: QuantOverledgerRequest req contentType res accept -> B.ByteString -> QuantOverledgerRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: QuantOverledgerRequest req contentType res accept -> BL.ByteString -> QuantOverledgerRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => QuantOverledgerRequest req contentType res accept -> P.Proxy authMethod -> QuantOverledgerRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> QuantOverledgerRequest req contentType res accept
    -> IO (QuantOverledgerRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> QuantOverledgerConfig
  -> IO (QuantOverledgerRequest req contentType res accept)
_applyAuthMethods req config@(QuantOverledgerConfig {configAuthMethods = as}) =
  foldlM go req as
  where
