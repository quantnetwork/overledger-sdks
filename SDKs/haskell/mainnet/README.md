## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Quant Overledger API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Quant Overledger API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | QuantOverledger                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | quant-overledger                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | QuantOverledgerConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | QuantOverledgerRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| QuantOverledger.Client    | use the "dispatch" functions to send requests       |
| QuantOverledger.Core      | core functions, config and request types            |
| QuantOverledger.API       | construct api requests                              |
| QuantOverledger.Model     | describes api models                                |
| QuantOverledger.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| QuantOverledger.ModelLens | lenses for model fields                             |
| QuantOverledger.Logging   | logging functions and utils                         |
