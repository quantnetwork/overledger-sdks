...
module QuantOverledger.API.CreateAQRC721TokenCollectionTransaction where
...
-- ** CreateAQRC721TokenCollectionTransaction

-- *** prepareCollectRequest

-- | @POST \/v2\/tokenise\/preparation\/transaction\/qrc721\/collect@
-- 
...
-- 
prepareCollectRequest
  :: (Consumes PrepareCollectRequest MimeJSON, MimeRender MimeJSON PreparePaymentTransactionRequestSchema)
  => PreparePaymentTransactionRequestSchema -- ^ "preparePaymentTransactionRequestSchema"
  -> Authorization -- ^ "authorization"
  -> QuantOverledgerRequest PrepareCollectRequest MimeJSON PrepareTransactionResponse MimeJSON
prepareCollectRequest preparePaymentTransactionRequestSchema (Authorization authorization) =
  _mkRequest "POST" ["/v2/tokenise/preparation/transaction/qrc721/collect"]
...
data PrepareCollectRequest 
instance HasBodyParam PrepareCollectRequest PreparePaymentTransactionRequestSchema 

-- | @application/json@
instance Consumes PrepareCollectRequest MimeJSON

-- | @application/json@
instance Produces PrepareCollectRequest MimeJSON
