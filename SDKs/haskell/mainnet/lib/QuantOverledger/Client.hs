...
module QuantOverledger.Client where
...
dispatchLbs
  ...
  -> QuantOverledgerConfig -- ^ config
  -> QuantOverledgerRequest req contentType res accept -- ^ request
