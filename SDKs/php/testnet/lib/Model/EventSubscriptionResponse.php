...
/**
 * EventSubscriptionResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EventSubscriptionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'token_name' => 'string',
        'subscription_details' => '\OpenAPI\Client\Model\EventSubscriptionResponseDetails',
    ...
    public function setTokenName($token_name)
    {
        if (!is_null($token_name) && (mb_strlen($token_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $token_name when calling EventSubscriptionResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($token_name) && (mb_strlen($token_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $token_name when calling EventSubscriptionResponse., must be bigger than or equal to 0.');
        }
        if (!is_null($token_name) && (!preg_match("/^[A-Za-z0-9 ]{1,100}/", $token_name))) {
            throw new \InvalidArgumentException("invalid value for $token_name when calling EventSubscriptionResponse., must conform to the pattern /^[A-Za-z0-9 ]{1,100}/.");
        }
     ...
     *
     * @return \OpenAPI\Client\Model\EventSubscriptionResponseDetails|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\EventSubscriptionResponseDetails|null $subscription_details subscription_details
     *
     * @return self
     */
    ...
    public function setType($type)
    {
        if (!is_null($type) && (mb_strlen($type) > 30)) {
            throw new \InvalidArgumentException('invalid length for $type when calling EventSubscriptionResponse., must be smaller than or equal to 30.');
        }
        if (!is_null($type) && (mb_strlen($type) < 0)) {
            throw new \InvalidArgumentException('invalid length for $type when calling EventSubscriptionResponse., must be bigger than or equal to 0.');
        }
        if (!is_null($type) && (!preg_match("/^[A-Za-z ]{1,30}/", $type))) {
            throw new \InvalidArgumentException("invalid value for $type when calling EventSubscriptionResponse., must conform to the pattern /^[A-Za-z ]{1,30}/.");
        }
