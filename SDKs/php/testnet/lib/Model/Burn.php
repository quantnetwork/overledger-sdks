 ...
 */
class Burn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Burn';
    ...
    public function setTokenName($token_name)
    {
        if (!is_null($token_name) && (mb_strlen($token_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $token_name when calling Burn., must be smaller than or equal to 100.');
        }
        if (!is_null($token_name) && (mb_strlen($token_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $token_name when calling Burn., must be bigger than or equal to 0.');
        }
        if (!is_null($token_name) && (!preg_match("/^[A-Za-z0-9 ]{1,100}/", $token_name))) {
            throw new \InvalidArgumentException("invalid value for $token_name when calling Burn., must conform to the pattern /^[A-Za-z0-9 ]{1,100}/.");
        }
    ...
    public function setAmount($amount)
    {
        if (!is_null($amount) && (mb_strlen($amount) > 100)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling Burn., must be smaller than or equal to 100.');
        }
        if (!is_null($amount) && (mb_strlen($amount) < 0)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling Burn., must be bigger than or equal to 0.');
        }
        if (!is_null($amount) && (!preg_match("/^[A-Za-z0-9. ]{1,100}/", $amount))) {
            throw new \InvalidArgumentException("invalid value for $amount when calling Burn., must conform to the pattern /^[A-Za-z0-9. ]{1,100}/.");
        }
    ...
    public function setUnit($unit)
    {
        if (!is_null($unit) && (mb_strlen($unit) > 11)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling Burn., must be smaller than or equal to 11.');
        }
        if (!is_null($unit) && (mb_strlen($unit) < 0)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling Burn., must be bigger than or equal to 0.');
        }
    ...
    public function setMetadata($metadata)
    {
        if (!is_null($metadata) && (mb_strlen($metadata) > 150)) {
            throw new \InvalidArgumentException('invalid length for $metadata when calling Burn., must be smaller than or equal to 150.');
        }
        if (!is_null($metadata) && (mb_strlen($metadata) < 0)) {
            throw new \InvalidArgumentException('invalid length for $metadata when calling Burn., must be bigger than or equal to 0.');
        }
        if (!is_null($metadata) && (!preg_match("/^[\\S\\s]{1,150}$/", $metadata))) {
            throw new \InvalidArgumentException("invalid value for $metadata when calling Burn., must conform to the pattern /^[\\S\\s]{1,150}$/.");
        }
    ...
    public function setTokenId($token_id)
    {
        if (!is_null($token_id) && (mb_strlen($token_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $token_id when calling Burn., must be smaller than or equal to 100.');
        }
        if (!is_null($token_id) && (mb_strlen($token_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $token_id when calling Burn., must be bigger than or equal to 0.');
        }
        if (!is_null($token_id) && (!preg_match("/^[A-Za-z0-9. ]{1,100}/", $token_id))) {
            throw new \InvalidArgumentException("invalid value for $token_id when calling Burn., must conform to the pattern /^[A-Za-z0-9. ]{1,100}/.");
        }
