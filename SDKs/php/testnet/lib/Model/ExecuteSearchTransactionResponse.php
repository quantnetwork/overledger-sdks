...
/**
 * ExecuteSearchTransactionResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExecuteSearchTransactionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExecuteSearchTransactionResponse';
     ...
     * Sets type
     *
     * @param string|null $type The type of the transaction object returned
     *
     * @return self
     */
    public function setType($type)
    {
        if (!is_null($type) && (mb_strlen($type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $type when calling ExecuteSearchTransactionResponse., must be smaller than or equal to 50.');
        }
        if (!is_null($type) && (mb_strlen($type) < 0)) {
            throw new \InvalidArgumentException('invalid length for $type when calling ExecuteSearchTransactionResponse., must be bigger than or equal to 0.');
        }
        if (!is_null($type) && (!preg_match("/^[a-zA-Z0-9-_ ]{1,50}$/", $type))) {
            throw new \InvalidArgumentException("invalid value for $type when calling ExecuteSearchTransactionResponse., must conform to the pattern /^[a-zA-Z0-9-_ ]{1,50}$/.");
        }
     ...
     * Sets timestamp
     *
     * @param string|null $timestamp The unix time to read the object from
     *
     * @return self
     */
    public function setTimestamp($timestamp)
    {
        if (!is_null($timestamp) && (mb_strlen($timestamp) > 50)) {
            throw new \InvalidArgumentException('invalid length for $timestamp when calling ExecuteSearchTransactionResponse., must be smaller than or equal to 50.');
        }
        if (!is_null($timestamp) && (mb_strlen($timestamp) < 0)) {
            throw new \InvalidArgumentException('invalid length for $timestamp when calling ExecuteSearchTransactionResponse., must be bigger than or equal to 0.');
        }
