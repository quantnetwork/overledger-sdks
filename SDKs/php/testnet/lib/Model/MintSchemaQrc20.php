...
/**
 * MintSchemaQrc20 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MintSchemaQrc20 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MintSchemaQrc20';
    ...
    public function setAmount($amount)
    {
        if ((mb_strlen($amount) > 100)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling MintSchemaQrc20., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($amount) < 0)) {
            throw new \InvalidArgumentException('invalid length for $amount when calling MintSchemaQrc20., must be bigger than or equal to 0.');
        }
        if ((!preg_match("/^[A-Za-z0-9. ]{1,100}/", $amount))) {
            throw new \InvalidArgumentException("invalid value for $amount when calling MintSchemaQrc20., must conform to the pattern /^[A-Za-z0-9. ]{1,100}/.");
        }
    ...
    public function setUnit($unit)
    {
        if (!is_null($unit) && (mb_strlen($unit) > 5)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling MintSchemaQrc20., must be smaller than or equal to 5.');
        }
        if (!is_null($unit) && (mb_strlen($unit) < 0)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling MintSchemaQrc20., must be bigger than or equal to 0.');
        }
        if (!is_null($unit) && (!preg_match("/^[A-Za-z0-9 ]{1,5}/", $unit))) {
            throw new \InvalidArgumentException("invalid value for $unit when calling MintSchemaQrc20., must conform to the pattern /^[A-Za-z0-9 ]{1,5}/.");
        }
