...
/**
 * SmartContractSearchFunctionSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SmartContractSearchFunctionSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmartContractSearchFunctionSchema';
    ...
    protected static $openAPITypes = [
        ...
        'output_parameters' => '\OpenAPI\Client\Model\SmartContractOutputParameterSchema[]'
    ];
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 20)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SmartContractSearchFunctionSchema., must be smaller than or equal to 20.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SmartContractSearchFunctionSchema., must be bigger than or equal to 0.');
        }
        if (!is_null($name) && (!preg_match("/^[A-Za-z0-9]{1,20}$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling SmartContractSearchFunctionSchema., must conform to the pattern /^[A-Za-z0-9]{1,20}$/.");
        }
    ...
    public function setInputParameters($input_parameters)
    {
        ...
        if (!is_null($input_parameters) && (count($input_parameters) > 20)) {
            throw new \InvalidArgumentException('invalid value for $input_parameters when calling SmartContractSearchFunctionSchema., number of items must be less than or equal to 20.');
        }
        if (!is_null($input_parameters) && (count($input_parameters) < 0)) {
            throw new \InvalidArgumentException('invalid length for $input_parameters when calling SmartContractSearchFunctionSchema., number of items must be greater than or equal to 0.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\SmartContractOutputParameterSchema[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\SmartContractOutputParameterSchema[]|null $output_parameters output_parameters
     *
     * @return self
     */
    public function setOutputParameters($output_parameters)
    {
        ...
        if (!is_null($output_parameters) && (count($output_parameters) > 10)) {
            throw new \InvalidArgumentException('invalid value for $output_parameters when calling SmartContractSearchFunctionSchema., number of items must be less than or equal to 10.');
        }
        if (!is_null($output_parameters) && (count($output_parameters) < 0)) {
            throw new \InvalidArgumentException('invalid length for $output_parameters when calling SmartContractSearchFunctionSchema., number of items must be greater than or equal to 0.');
        }
