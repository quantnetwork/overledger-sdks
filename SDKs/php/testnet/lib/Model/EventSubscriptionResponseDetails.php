...
/**
 * EventSubscriptionResponseDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EventSubscriptionResponseDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventSubscriptionResponseDetails';
    ...
    public function setSubscriptionId($subscription_id)
    {
        if (!is_null($subscription_id) && (mb_strlen($subscription_id) > 24)) {
            throw new \InvalidArgumentException('invalid length for $subscription_id when calling EventSubscriptionResponseDetails., must be smaller than or equal to 24.');
        }
        if (!is_null($subscription_id) && (mb_strlen($subscription_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $subscription_id when calling EventSubscriptionResponseDetails., must be bigger than or equal to 0.');
        }
        if (!is_null($subscription_id) && (!preg_match("/^[a-z0-9-]{1,24}$/", $subscription_id))) {
            throw new \InvalidArgumentException("invalid value for $subscription_id when calling EventSubscriptionResponseDetails., must conform to the pattern /^[a-z0-9-]{1,24}$/.");
        }
    ...
    public function setCallbackUrl($callback_url)
    {
        if (!is_null($callback_url) && (mb_strlen($callback_url) > 300)) {
            throw new \InvalidArgumentException('invalid length for $callback_url when calling EventSubscriptionResponseDetails., must be smaller than or equal to 300.');
        }
        if (!is_null($callback_url) && (mb_strlen($callback_url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $callback_url when calling EventSubscriptionResponseDetails., must be bigger than or equal to 0.');
        }
        if (!is_null($callback_url) && (!preg_match("/^http[\\S\\s]{1,300}$/", $callback_url))) {
            throw new \InvalidArgumentException("invalid value for $callback_url when calling EventSubscriptionResponseDetails., must conform to the pattern /^http[\\S\\s]{1,300}$/.");
        }
