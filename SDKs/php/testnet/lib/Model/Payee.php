...
class Payee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['payee_id']) && !preg_match("/^[a-zA-Z0-9:,\/.=\\-\\s]{1,500}/", $this->container['payee_id'])) {
            $invalidProperties[] = "invalid value for 'payee_id', must be conform to the pattern /^[a-zA-Z0-9:,\/.=\\-\\s]{1,500}/.";
        }
     ...
     * Sets payee_id
     *
     * @param string|null $payee_id The unique identifiers of the payee
     *
     * @return self
     */
    public function setPayeeId($payee_id)
    {
        if (!is_null($payee_id) && (mb_strlen($payee_id) > 500)) {
            throw new \InvalidArgumentException('invalid length for $payee_id when calling Payee., must be smaller than or equal to 500.');
        }
        if (!is_null($payee_id) && (mb_strlen($payee_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $payee_id when calling Payee., must be bigger than or equal to 0.');
        }
        if (!is_null($payee_id) && (!preg_match("/^[a-zA-Z0-9:,\/.=\\-\\s]{1,500}/", $payee_id))) {
            throw new \InvalidArgumentException("invalid value for $payee_id when calling Payee., must conform to the pattern /^[a-zA-Z0-9:,\/.=\\-\\s]{1,500}/.");
        }
