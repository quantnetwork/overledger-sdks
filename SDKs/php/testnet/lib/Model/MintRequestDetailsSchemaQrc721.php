...
/**
 * MintRequestDetailsSchemaQrc721 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MintRequestDetailsSchemaQrc721 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MintRequestDetailsSchemaQrc721';
    ...
    protected static $openAPITypes = [
        'beneficiary' => '\OpenAPI\Client\Model\BeneficiaryMintSchemaQrc721',
     ...
     * Gets beneficiary
     *
     * @return \OpenAPI\Client\Model\BeneficiaryMintSchemaQrc721|null
     */
     ...
     * Sets beneficiary
     *
     * @param \OpenAPI\Client\Model\BeneficiaryMintSchemaQrc721|null $beneficiary beneficiary
     *
     * @return self
     */
    ...
    public function setOverledgerSigningType($overledger_signing_type)
    {
        if (!is_null($overledger_signing_type) && (mb_strlen($overledger_signing_type) > 30)) {
            throw new \InvalidArgumentException('invalid length for $overledger_signing_type when calling MintRequestDetailsSchemaQrc721., must be smaller than or equal to 30.');
        }
        if (!is_null($overledger_signing_type) && (mb_strlen($overledger_signing_type) < 0)) {
            throw new \InvalidArgumentException('invalid length for $overledger_signing_type when calling MintRequestDetailsSchemaQrc721., must be bigger than or equal to 0.');
        }
        if (!is_null($overledger_signing_type) && (!preg_match("/^[A-Za-z- ]{1,30}/", $overledger_signing_type))) {
            throw new \InvalidArgumentException("invalid value for $overledger_signing_type when calling MintRequestDetailsSchemaQrc721., must conform to the pattern /^[A-Za-z- ]{1,30}/.");
        }
