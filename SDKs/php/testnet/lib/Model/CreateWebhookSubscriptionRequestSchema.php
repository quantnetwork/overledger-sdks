...
/**
 * CreateWebhookSubscriptionRequestSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateWebhookSubscriptionRequestSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateWebhookSubscriptionRequestSchema';
    ...
    public function setType($type)
    {
        if (!is_null($type) && (mb_strlen($type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $type when calling CreateWebhookSubscriptionRequestSchema., must be smaller than or equal to 50.');
        }
        if (!is_null($type) && (mb_strlen($type) < 0)) {
            throw new \InvalidArgumentException('invalid length for $type when calling CreateWebhookSubscriptionRequestSchema., must be bigger than or equal to 0.');
        }
        if (!is_null($type) && (!preg_match("/^[a-zA-Z0-9-_ ]{1,50}$/", $type))) {
            throw new \InvalidArgumentException("invalid value for $type when calling CreateWebhookSubscriptionRequestSchema., must conform to the pattern /^[a-zA-Z0-9-_ ]{1,50}$/.");
        }
    ...
    public function setIds($ids)
    {
        ...
        if (!is_null($ids) && (count($ids) > 36)) {
            throw new \InvalidArgumentException('invalid value for $ids when calling CreateWebhookSubscriptionRequestSchema., number of items must be less than or equal to 36.');
        }
        if (!is_null($ids) && (count($ids) < 0)) {
            throw new \InvalidArgumentException('invalid length for $ids when calling CreateWebhookSubscriptionRequestSchema., number of items must be greater than or equal to 0.');
        }
    ...
    public function setCallbackUrl($callback_url)
    {
        if (!is_null($callback_url) && (mb_strlen($callback_url) > 300)) {
            throw new \InvalidArgumentException('invalid length for $callback_url when calling CreateWebhookSubscriptionRequestSchema., must be smaller than or equal to 300.');
        }
        if (!is_null($callback_url) && (mb_strlen($callback_url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $callback_url when calling CreateWebhookSubscriptionRequestSchema., must be bigger than or equal to 0.');
        }
        if (!is_null($callback_url) && (!preg_match("/^http[\\S\\s]{1,300}$/", $callback_url))) {
            throw new \InvalidArgumentException("invalid value for $callback_url when calling CreateWebhookSubscriptionRequestSchema., must conform to the pattern /^http[\\S\\s]{1,300}$/.");
        }
