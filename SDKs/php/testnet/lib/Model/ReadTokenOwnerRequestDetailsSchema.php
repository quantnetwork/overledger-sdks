...
/**
 * ReadTokenOwnerRequestDetailsSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReadTokenOwnerRequestDetailsSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReadTokenOwnerRequestDetailsSchema';
    ...
    public function setTokenId($token_id)
    {
        if (!is_null($token_id) && (mb_strlen($token_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $token_id when calling ReadTokenOwnerRequestDetailsSchema., must be smaller than or equal to 100.');
        }
        if (!is_null($token_id) && (mb_strlen($token_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $token_id when calling ReadTokenOwnerRequestDetailsSchema., must be bigger than or equal to 0.');
        }
        if (!is_null($token_id) && (!preg_match("/^[A-Za-z0-9. ]{1,100}/", $token_id))) {
            throw new \InvalidArgumentException("invalid value for $token_id when calling ReadTokenOwnerRequestDetailsSchema., must conform to the pattern /^[A-Za-z0-9. ]{1,100}/.");
        }
    ...
    public function setTokenName($token_name)
    {
        if (!is_null($token_name) && (mb_strlen($token_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $token_name when calling ReadTokenOwnerRequestDetailsSchema., must be smaller than or equal to 100.');
        }
        if (!is_null($token_name) && (mb_strlen($token_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $token_name when calling ReadTokenOwnerRequestDetailsSchema., must be bigger than or equal to 0.');
        }
        if (!is_null($token_name) && (!preg_match("/^[A-Za-z0-9 ]{1,100}/", $token_name))) {
            throw new \InvalidArgumentException("invalid value for $token_name when calling ReadTokenOwnerRequestDetailsSchema., must conform to the pattern /^[A-Za-z0-9 ]{1,100}/.");
        }
