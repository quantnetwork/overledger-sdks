...
/**
 * ManageQRC20TokenSupplyApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class ManageQRC20TokenSupplyApi
{
    ...
    public function executePreparedRequestTransactionRequest($authorization, $execute_transaction_request)
    {
        ...
        if (strlen($authorization) > 5010) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling ManageQRC20TokenSupplyApi.executePreparedRequestTransaction, must be smaller than or equal to 5010.');
        }
        if (strlen($authorization) < 0) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling ManageQRC20TokenSupplyApi.executePreparedRequestTransaction, must be bigger than or equal to 0.');
        }
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling ManageQRC20TokenSupplyApi.executePreparedRequestTransaction, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/.");
        }
    ...
    /**
     * Operation prepareSupplyRequest1
     *
     * Prepare a request to manage QRC20 token supply
     *
     * @param  string $authorization authorization (required)
     * @param  \OpenAPI\Client\Model\PrepareMintTransactionRequestSchemaQrc20 $prepare_mint_transaction_request_schema_qrc20 prepare_mint_transaction_request_schema_qrc20 (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function prepareSupplyRequest1($authorization, $prepare_mint_transaction_request_schema_qrc20)
    {
        list($response) = $this->prepareSupplyRequest1WithHttpInfo($authorization, $prepare_mint_transaction_request_schema_qrc20);
        return $response;
    }

    /**
     * Operation prepareSupplyRequest1WithHttpInfo
     *
     * Prepare a request to manage QRC20 token supply
     *
     * @param  string $authorization (required)
     * @param  \OpenAPI\Client\Model\PrepareMintTransactionRequestSchemaQrc20 $prepare_mint_transaction_request_schema_qrc20 (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function prepareSupplyRequest1WithHttpInfo($authorization, $prepare_mint_transaction_request_schema_qrc20)
    {
        $request = $this->prepareSupplyRequest1Request($authorization, $prepare_mint_transaction_request_schema_qrc20);
    ...
    /**
     * Operation prepareSupplyRequest1Async
     *
     * Prepare a request to manage QRC20 token supply
     *
     * @param  string $authorization (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function prepareSupplyRequest1Async($authorization, $prepare_mint_transaction_request_schema_qrc20)
    {
        return $this->prepareSupplyRequest1AsyncWithHttpInfo($authorization, $prepare_mint_transaction_request_schema_qrc20)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation prepareSupplyRequest1AsyncWithHttpInfo
     *
     * Prepare a request to manage QRC20 token supply
     *
     * @param  string $authorization (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function prepareSupplyRequest1AsyncWithHttpInfo($authorization, $prepare_mint_transaction_request_schema_qrc20)
    {
        $returnType = '\OpenAPI\Client\Model\PrepareTransactionResponse';
        $request = $this->prepareSupplyRequest1Request($authorization, $prepare_mint_transaction_request_schema_qrc20);
    ...
    /**
     * Create request for operation 'prepareSupplyRequest1'
     *
     * @param  string $authorization (required)
     * @param  \OpenAPI\Client\Model\PrepareMintTransactionRequestSchemaQrc20 $prepare_mint_transaction_request_schema_qrc20 (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function prepareSupplyRequest1Request($authorization, $prepare_mint_transaction_request_schema_qrc20)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling prepareSupplyRequest1'
            );
        }
        if (strlen($authorization) > 5010) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling ManageQRC20TokenSupplyApi.prepareSupplyRequest1, must be smaller than or equal to 5010.');
        }
        if (strlen($authorization) < 0) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling ManageQRC20TokenSupplyApi.prepareSupplyRequest1, must be bigger than or equal to 0.');
        }
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling ManageQRC20TokenSupplyApi.prepareSupplyRequest1, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/.");
        }

        // verify the required parameter 'prepare_mint_transaction_request_schema_qrc20' is set
        if ($prepare_mint_transaction_request_schema_qrc20 === null || (is_array($prepare_mint_transaction_request_schema_qrc20) && count($prepare_mint_transaction_request_schema_qrc20) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $prepare_mint_transaction_request_schema_qrc20 when calling prepareSupplyRequest1'
            );
        }

        $resourcePath = '/v2/preparation/supply';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($prepare_mint_transaction_request_schema_qrc20)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($prepare_mint_transaction_request_schema_qrc20));
            } else {
                $httpBody = $prepare_mint_transaction_request_schema_qrc20;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
