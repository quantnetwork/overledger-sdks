...
class CreateTransactionApi
{
    ...
    public function executePreparedRequestNativeTransactionRequest($authorization, $execute_transaction_request)
    {
        ...
        if (strlen($authorization) > 5010) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateTransactionApi.executePreparedRequestNativeTransaction, must be smaller than or equal to 5010.');
        }
        ...
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling CreateTransactionApi.executePreparedRequestNativeTransaction, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/.");
        }
    ...
    public function executePreparedRequestTransactionRequest($authorization, $execute_transaction_request)
    {
        ...
        if (strlen($authorization) > 5010) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateTransactionApi.executePreparedRequestTransaction, must be smaller than or equal to 5010.');
        }
        if (strlen($authorization) < 0) {
        ...
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling CreateTransactionApi.executePreparedRequestTransaction, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/.");
        }
    ...
    public function prepareNativeTransactionRequest($authorization, $prepare_native_transaction_request_schema)
    {
        ...
        if (strlen($authorization) > 5010) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateTransactionApi.prepareNativeTransaction, must be smaller than or equal to 5010.');
        }
        if (strlen($authorization) < 0) {
        ...
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling CreateTransactionApi.prepareNativeTransaction, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/.");
        }
    ...
    /**
     * Operation prepareTransactionRequest
     *
    ...
    /**
     * Operation prepareTransactionRequestWithHttpInfo
     *
     * Prepare a DLT transaction for signing
     *
     * @param  string $authorization (required)
    ...
    /**
     * Operation prepareTransactionRequestAsync
     *
     * Prepare a DLT transaction for signing
     *
     * @param  string $authorization (required)
    ...
    /**
     * Operation prepareTransactionRequestAsyncWithHttpInfo
     *
     * Prepare a DLT transaction for signing
     *
     * @param  string $authorization (required)
    ...
    public function prepareTransactionRequestRequest($authorization, $prepare_payment_transaction_request_schema)
    {
        ...
        if (strlen($authorization) > 5010) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateTransactionApi.prepareTransactionRequest, must be smaller than or equal to 5010.');
        }
        if (strlen($authorization) < 0) {
        ...
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling CreateTransactionApi.prepareTransactionRequest, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/.");
        }
