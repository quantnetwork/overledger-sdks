...
/**
 * CreateAQRC721TransferTransactionApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class CreateAQRC721TransferTransactionApi
{
    ...
    public function prepareTransactionRequestRequest($authorization, $prepare_payment_transaction_request_schema)
    {
        ...
        if (strlen($authorization) > 5010) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateAQRC721TransferTransactionApi.prepareTransactionRequest, must be smaller than or equal to 5010.');
        }
        if (strlen($authorization) < 0) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateAQRC721TransferTransactionApi.prepareTransactionRequest, must be bigger than or equal to 0.');
        }
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling CreateAQRC721TransferTransactionApi.prepareTransactionRequest, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/.");
        }
        ...
        $resourcePath = '/v2/tokenise/preparation/transaction/qrc721/transfer';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
