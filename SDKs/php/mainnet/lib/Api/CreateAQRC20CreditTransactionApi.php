...
/**
 * CreateAQRC20CreditTransactionApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class CreateAQRC20CreditTransactionApi
{
    ...
    public function executePreparedRequestTransactionRequest($authorization, $execute_transaction_request)
    {
        ...
        if (strlen($authorization) > 5010) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateAQRC20CreditTransactionApi.executePreparedRequestTransaction, must be smaller than or equal to 5010.');
        }
        if (strlen($authorization) < 0) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateAQRC20CreditTransactionApi.executePreparedRequestTransaction, must be bigger than or equal to 0.');
        }
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling CreateAQRC20CreditTransactionApi.executePreparedRequestTransaction, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/.");
        }
    ...
    /**
     * Operation prepareCreditRequest
     *
     * Prepare a QRC20 token credit transaction for signing
     *
     * @param  string $authorization authorization (required)
     * @param  \OpenAPI\Client\Model\PrepareCreditTransactionRequestSchema $prepare_credit_transaction_request_schema prepare_credit_transaction_request_schema (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function prepareCreditRequest($authorization, $prepare_credit_transaction_request_schema)
    {
        list($response) = $this->prepareCreditRequestWithHttpInfo($authorization, $prepare_credit_transaction_request_schema);
        return $response;
    }

    /**
     * Operation prepareCreditRequestWithHttpInfo
     *
     * Prepare a QRC20 token credit transaction for signing
     *
     * @param  string $authorization (required)
     * @param  \OpenAPI\Client\Model\PrepareCreditTransactionRequestSchema $prepare_credit_transaction_request_schema (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function prepareCreditRequestWithHttpInfo($authorization, $prepare_credit_transaction_request_schema)
    {
        $request = $this->prepareCreditRequestRequest($authorization, $prepare_credit_transaction_request_schema);
    ...
    /**
     * Operation prepareCreditRequestAsync
     *
     * Prepare a QRC20 token credit transaction for signing
     *
     * @param  string $authorization (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function prepareCreditRequestAsync($authorization, $prepare_credit_transaction_request_schema)
    {
        return $this->prepareCreditRequestAsyncWithHttpInfo($authorization, $prepare_credit_transaction_request_schema)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation prepareCreditRequestAsyncWithHttpInfo
     *
     * Prepare a QRC20 token credit transaction for signing
     *
     * @param  string $authorization (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function prepareCreditRequestAsyncWithHttpInfo($authorization, $prepare_credit_transaction_request_schema)
    {
        $returnType = '\OpenAPI\Client\Model\PrepareTransactionResponse';
        $request = $this->prepareCreditRequestRequest($authorization, $prepare_credit_transaction_request_schema);
    ...
    /**
     * Create request for operation 'prepareCreditRequest'
     *
     * @param  string $authorization (required)
     * @param  \OpenAPI\Client\Model\PrepareCreditTransactionRequestSchema $prepare_credit_transaction_request_schema (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function prepareCreditRequestRequest($authorization, $prepare_credit_transaction_request_schema)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling prepareCreditRequest'
            );
        }
        if (strlen($authorization) > 5010) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateAQRC20CreditTransactionApi.prepareCreditRequest, must be smaller than or equal to 5010.');
        }
        if (strlen($authorization) < 0) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateAQRC20CreditTransactionApi.prepareCreditRequest, must be bigger than or equal to 0.');
        }
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling CreateAQRC20CreditTransactionApi.prepareCreditRequest, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/.");
        }

        // verify the required parameter 'prepare_credit_transaction_request_schema' is set
        if ($prepare_credit_transaction_request_schema === null || (is_array($prepare_credit_transaction_request_schema) && count($prepare_credit_transaction_request_schema) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $prepare_credit_transaction_request_schema when calling prepareCreditRequest'
            );
        }

        $resourcePath = '/v2/preparation/credit';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($prepare_credit_transaction_request_schema)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($prepare_credit_transaction_request_schema));
            } else {
                $httpBody = $prepare_credit_transaction_request_schema;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
