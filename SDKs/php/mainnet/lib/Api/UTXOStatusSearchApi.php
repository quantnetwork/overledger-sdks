...
class UTXOStatusSearchApi
{
    ...
    public function executeUTXOPreparedSearchRequestRequest($authorization, $request_id)
    {
        ...
        if (strlen($authorization) > 4096) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling UTXOStatusSearchApi.executeUTXOPreparedSearchRequest, must be smaller than or equal to 4096.');
        }
        ...
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,4096}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling UTXOStatusSearchApi.executeUTXOPreparedSearchRequest, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,4096}$/.");
        }
    ...
    public function prepareSearchUTXOStateRequest($authorization, $utxo_id, $prepare_search_schema)
    {
        ...
        if (strlen($authorization) > 4096) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling UTXOStatusSearchApi.prepareSearchUTXOState, must be smaller than or equal to 4096.');
        }
        if (strlen($authorization) < 0) {
        ...
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,4096}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling UTXOStatusSearchApi.prepareSearchUTXOState, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,4096}$/.");
        }
