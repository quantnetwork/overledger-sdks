...
/**
 * CreateAQRC20DebitTransactionApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class CreateAQRC20DebitTransactionApi
{
    ...
    public function executePreparedRequestTransactionRequest($authorization, $execute_transaction_request)
    {
        ...
        if (strlen($authorization) > 5010) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateAQRC20DebitTransactionApi.executePreparedRequestTransaction, must be smaller than or equal to 5010.');
        }
        if (strlen($authorization) < 0) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateAQRC20DebitTransactionApi.executePreparedRequestTransaction, must be bigger than or equal to 0.');
        }
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling CreateAQRC20DebitTransactionApi.executePreparedRequestTransaction, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/.");
        }
     ...
     */
    public function prepareDebitRequest($authorization, $prepare_credit_transaction_request_schema)
    {
        list($response) = $this->prepareDebitRequestWithHttpInfo($authorization, $prepare_credit_transaction_request_schema);
        return $response;
    }

    /**
     * Operation prepareDebitRequestWithHttpInfo
     *
     * Prepare a QRC20 token debit transaction for signing
     *
     * @param  string $authorization (required)
     ...
     */
    public function prepareDebitRequestWithHttpInfo($authorization, $prepare_credit_transaction_request_schema)
    {
        $request = $this->prepareDebitRequestRequest($authorization, $prepare_credit_transaction_request_schema);
    ...
    /**
     * Operation prepareDebitRequestAsync
     *
     * Prepare a QRC20 token debit transaction for signing
     *
     * @param  string $authorization (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function prepareDebitRequestAsync($authorization, $prepare_credit_transaction_request_schema)
    {
        return $this->prepareDebitRequestAsyncWithHttpInfo($authorization, $prepare_credit_transaction_request_schema)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation prepareDebitRequestAsyncWithHttpInfo
     *
     * Prepare a QRC20 token debit transaction for signing
     *
     * @param  string $authorization (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function prepareDebitRequestAsyncWithHttpInfo($authorization, $prepare_credit_transaction_request_schema)
    {
        $returnType = '\OpenAPI\Client\Model\PrepareTransactionResponse';
        $request = $this->prepareDebitRequestRequest($authorization, $prepare_credit_transaction_request_schema);
    ...
    /**
     * Create request for operation 'prepareDebitRequest'
     *
     * @param  string $authorization (required)
     * @param  \OpenAPI\Client\Model\PrepareCreditTransactionRequestSchema $prepare_credit_transaction_request_schema (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function prepareDebitRequestRequest($authorization, $prepare_credit_transaction_request_schema)
    {
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling prepareDebitRequest'
            );
        }
        if (strlen($authorization) > 5010) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateAQRC20DebitTransactionApi.prepareDebitRequest, must be smaller than or equal to 5010.');
        }
        if (strlen($authorization) < 0) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateAQRC20DebitTransactionApi.prepareDebitRequest, must be bigger than or equal to 0.');
        }
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling CreateAQRC20DebitTransactionApi.prepareDebitRequest, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/.");
        }
        ...
        if ($prepare_credit_transaction_request_schema === null || (is_array($prepare_credit_transaction_request_schema) && count($prepare_credit_transaction_request_schema) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $prepare_credit_transaction_request_schema when calling prepareDebitRequest'
            );
        }

        $resourcePath = '/v2/preparation/debit';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
