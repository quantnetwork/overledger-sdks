...
/**
 * SubscribeToQRC721SupplyChangeUpdatesApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class SubscribeToQRC721SupplyChangeUpdatesApi
{
    ...
    public function subscribeSupplyEventRequest($authorization, $flowtype, $body)
    {
        ...
        if (strlen($authorization) > 5010) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling SubscribeToQRC721SupplyChangeUpdatesApi.subscribeSupplyEvent, must be smaller than or equal to 5010.');
        }
        if (strlen($authorization) < 0) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling SubscribeToQRC721SupplyChangeUpdatesApi.subscribeSupplyEvent, must be bigger than or equal to 0.');
        }
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling SubscribeToQRC721SupplyChangeUpdatesApi.subscribeSupplyEvent, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,5010}$/.");
        }
