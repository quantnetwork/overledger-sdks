...
class ExecuteSearchUTXOResponseSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setTimestamp($timestamp)
    {
        if (!is_null($timestamp) && (mb_strlen($timestamp) > 50)) {
            throw new \InvalidArgumentException('invalid length for $timestamp when calling ExecuteSearchUTXOResponseSchema., must be smaller than or equal to 50.');
        }
        if (!is_null($timestamp) && (mb_strlen($timestamp) < 0)) {
            throw new \InvalidArgumentException('invalid length for $timestamp when calling ExecuteSearchUTXOResponseSchema., must be bigger than or equal to 0.');
        }
