...
class DestinationPaymentSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets destination_id
     *
     * @param string $destination_id Unique identifier of the destination/recipient
     *
     * @return self
     */
    public function setDestinationId($destination_id)
    {
        if ((mb_strlen($destination_id) > 66)) {
        ...
        if ((!preg_match("/^[A-Za-z0-9:]{1,66}/", $destination_id))) {
     ...
     * Gets payment
     *
     * @return \OpenAPI\Client\Model\PaymentSchema
     */
     ...
     * Sets payment
     *
     * @param \OpenAPI\Client\Model\PaymentSchema $payment payment
     *
     * @return self
     */
