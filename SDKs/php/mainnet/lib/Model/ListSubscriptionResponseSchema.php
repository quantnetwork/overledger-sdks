...
/**
 * ListSubscriptionResponseSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListSubscriptionResponseSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListSubscriptionResponseSchema';
    ...
    protected static $openAPITypes = [
        'subscription_details' => '\OpenAPI\Client\Model\SubscriptionDetailsSchema',
     ...
     *
     * @return \OpenAPI\Client\Model\SubscriptionDetailsSchema|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\SubscriptionDetailsSchema|null $subscription_details subscription_details
     *
     * @return self
     */
    ...
    public function setCallbackUrl($callback_url)
    {
        if (!is_null($callback_url) && (mb_strlen($callback_url) > 300)) {
            throw new \InvalidArgumentException('invalid length for $callback_url when calling ListSubscriptionResponseSchema., must be smaller than or equal to 300.');
        }
        if (!is_null($callback_url) && (mb_strlen($callback_url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $callback_url when calling ListSubscriptionResponseSchema., must be bigger than or equal to 0.');
        }
        if (!is_null($callback_url) && (!preg_match("/^http[\\S\\s]{1,300}$/", $callback_url))) {
            throw new \InvalidArgumentException("invalid value for $callback_url when calling ListSubscriptionResponseSchema., must conform to the pattern /^http[\\S\\s]{1,300}$/.");
        }
    ...
    public function setSubscriptionId($subscription_id)
    {
        if (!is_null($subscription_id) && (mb_strlen($subscription_id) > 24)) {
            throw new \InvalidArgumentException('invalid length for $subscription_id when calling ListSubscriptionResponseSchema., must be smaller than or equal to 24.');
        }
        if (!is_null($subscription_id) && (mb_strlen($subscription_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $subscription_id when calling ListSubscriptionResponseSchema., must be bigger than or equal to 0.');
        }
        if (!is_null($subscription_id) && (!preg_match("/^[a-z0-9-]{1,24}$/", $subscription_id))) {
            throw new \InvalidArgumentException("invalid value for $subscription_id when calling ListSubscriptionResponseSchema., must conform to the pattern /^[a-z0-9-]{1,24}$/.");
        }
    ...
    public function setType($type)
    {
        if (!is_null($type) && (mb_strlen($type) > 24)) {
            throw new \InvalidArgumentException('invalid length for $type when calling ListSubscriptionResponseSchema., must be smaller than or equal to 24.');
        }
        if (!is_null($type) && (mb_strlen($type) < 0)) {
            throw new \InvalidArgumentException('invalid length for $type when calling ListSubscriptionResponseSchema., must be bigger than or equal to 0.');
        }
        if (!is_null($type) && (!preg_match("/^[a-zA-Z0-9-_ ]{1,50}$/", $type))) {
            throw new \InvalidArgumentException("invalid value for $type when calling ListSubscriptionResponseSchema., must conform to the pattern /^[a-zA-Z0-9-_ ]{1,50}$/.");
        }
