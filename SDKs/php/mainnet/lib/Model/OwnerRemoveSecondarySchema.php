...
/**
 * OwnerRemoveSecondarySchema Class Doc Comment
 *
 * @category Class
 ...
 */
class OwnerRemoveSecondarySchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OwnerRemoveSecondarySchema';
     ...
     * Sets account_id
     *
     * @param string|null $account_id Unique Identifier of the owner
     *
     * @return self
     */
    public function setAccountId($account_id)
    {
        if (!is_null($account_id) && (mb_strlen($account_id) > 500)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling OwnerRemoveSecondarySchema., must be smaller than or equal to 500.');
        }
        if (!is_null($account_id) && (mb_strlen($account_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling OwnerRemoveSecondarySchema., must be bigger than or equal to 0.');
        }
        if (!is_null($account_id) && (!preg_match("/^[a-zA-Z0-9:,\/.=\\-\\s]{1,500}/", $account_id))) {
            throw new \InvalidArgumentException("invalid value for $account_id when calling OwnerRemoveSecondarySchema., must conform to the pattern /^[a-zA-Z0-9:,\/.=\\-\\s]{1,500}/.");
        }
    ...
    public function setUnit($unit)
    {
        if (!is_null($unit) && (mb_strlen($unit) > 5)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling OwnerRemoveSecondarySchema., must be smaller than or equal to 5.');
        }
        if (!is_null($unit) && (mb_strlen($unit) < 0)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling OwnerRemoveSecondarySchema., must be bigger than or equal to 0.');
        }
        if (!is_null($unit) && (!preg_match("/^[A-Za-z0-9 ]{1,5}/", $unit))) {
            throw new \InvalidArgumentException("invalid value for $unit when calling OwnerRemoveSecondarySchema., must conform to the pattern /^[A-Za-z0-9 ]{1,5}/.");
        }
