...
class Beneficiary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'account_id' => 'string',
        'mint' => '\OpenAPI\Client\Model\Mint'
    ];
    ...
    public function setAccountId($account_id)
    {
        if (!is_null($account_id) && (mb_strlen($account_id) > 500)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling Beneficiary., must be smaller than or equal to 500.');
        }
        if (!is_null($account_id) && (mb_strlen($account_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling Beneficiary., must be bigger than or equal to 0.');
        }
     ...
     * Gets mint
     *
     * @return \OpenAPI\Client\Model\Mint|null
     */
     ...
     * Sets mint
     *
     * @param \OpenAPI\Client\Model\Mint|null $mint mint
     *
     * @return self
     */
