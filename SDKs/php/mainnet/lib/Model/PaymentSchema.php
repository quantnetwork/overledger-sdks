...
class PaymentSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['unit']) > 5)) {
        ...
        if (!preg_match("/^[A-Za-z0-9 ]{1,5}/", $this->container['unit'])) {
     ...
     * Sets amount
     *
     * @param string $amount The payload amount. The exact format depends on the unit of the token.
     *
     * @return self
     */
     ...
     * Sets unit
     *
     * @param string $unit The currency or token code
     *
     * @return self
     */
    public function setUnit($unit)
    {
        ...
        if ((!preg_match("/^[A-Za-z0-9 ]{1,5}/", $unit))) {
