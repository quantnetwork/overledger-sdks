...
/**
 * ListWebhookSubscriptionResponseSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListWebhookSubscriptionResponseSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListWebhookSubscriptionResponseSchema';
    ...
    protected static $openAPITypes = [
        'subscription_details' => '\OpenAPI\Client\Model\WebhookSubscriptionDetailsSchema',
    ...
    protected static $setters = [
        ...
        'type' => 'setType',
        'subscribed_time' => 'setSubscribedTime'
    ];
    ...
    protected static $getters = [
        ...
        'type' => 'getType',
        'subscribed_time' => 'getSubscribedTime'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['subscribed_time'] = $data['subscribed_time'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['type']) && (mb_strlen($this->container['type']) > 24)) {
            $invalidProperties[] = "invalid value for 'type', the character length must be smaller than or equal to 24.";
        }
     ...
     *
     * @param \OpenAPI\Client\Model\WebhookSubscriptionDetailsSchema|null $subscription_details subscription_details
     *
     * @return self
     */
    ...
    public function setCallbackUrl($callback_url)
    {
        if (!is_null($callback_url) && (mb_strlen($callback_url) > 300)) {
            throw new \InvalidArgumentException('invalid length for $callback_url when calling ListWebhookSubscriptionResponseSchema., must be smaller than or equal to 300.');
        }
        if (!is_null($callback_url) && (mb_strlen($callback_url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $callback_url when calling ListWebhookSubscriptionResponseSchema., must be bigger than or equal to 0.');
        }
        if (!is_null($callback_url) && (!preg_match("/^http[\\S\\s]{1,300}$/", $callback_url))) {
            throw new \InvalidArgumentException("invalid value for $callback_url when calling ListWebhookSubscriptionResponseSchema., must conform to the pattern /^http[\\S\\s]{1,300}$/.");
        }
    ...
    public function setSubscriptionId($subscription_id)
    {
        if (!is_null($subscription_id) && (mb_strlen($subscription_id) > 24)) {
            throw new \InvalidArgumentException('invalid length for $subscription_id when calling ListWebhookSubscriptionResponseSchema., must be smaller than or equal to 24.');
        }
        if (!is_null($subscription_id) && (mb_strlen($subscription_id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $subscription_id when calling ListWebhookSubscriptionResponseSchema., must be bigger than or equal to 0.');
        }
        if (!is_null($subscription_id) && (!preg_match("/^[a-z0-9-]{1,24}$/", $subscription_id))) {
            throw new \InvalidArgumentException("invalid value for $subscription_id when calling ListWebhookSubscriptionResponseSchema., must conform to the pattern /^[a-z0-9-]{1,24}$/.");
        }
    ...
    {
        if (!is_null($type) && (mb_strlen($type) > 24)) {
            throw new \InvalidArgumentException('invalid length for $type when calling ListWebhookSubscriptionResponseSchema., must be smaller than or equal to 24.');
        }
        if (!is_null($type) && (mb_strlen($type) < 0)) {
            throw new \InvalidArgumentException('invalid length for $type when calling ListWebhookSubscriptionResponseSchema., must be bigger than or equal to 0.');
        }
        if (!is_null($type) && (!preg_match("/^[a-zA-Z0-9-_ ]{1,50}$/", $type))) {
            throw new \InvalidArgumentException("invalid value for $type when calling ListWebhookSubscriptionResponseSchema., must conform to the pattern /^[a-zA-Z0-9-_ ]{1,50}$/.");
        }
    ...
    /**
     * Gets subscribed_time
     *
     * @return \DateTime|null
     */
    public function getSubscribedTime()
    {
        return $this->container['subscribed_time'];
    }

    /**
     * Sets subscribed_time
     *
     * @param \DateTime|null $subscribed_time subscribed_time
     *
     * @return self
     */
    public function setSubscribedTime($subscribed_time)
    {
        $this->container['subscribed_time'] = $subscribed_time;
