...
class CreateSubscriptionApi
{
    ...
    public function subscriptionRequest($authorization, $create_subscription_request_schema)
    {
        ...
        if (strlen($authorization) > 1024) {
            throw new \InvalidArgumentException('invalid length for "$authorization" when calling CreateSubscriptionApi.subscription, must be smaller than or equal to 1024.');
        }
        ...
        if (!preg_match("/^Bearer [A-Za-z0-9\\-_. ]{1,1024}$/", $authorization)) {
            throw new \InvalidArgumentException("invalid value for \"authorization\" when calling CreateSubscriptionApi.subscription, must conform to the pattern /^Bearer [A-Za-z0-9\\-_. ]{1,1024}$/.");
        }
