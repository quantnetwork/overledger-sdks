...
pub struct PrepareBurnTransactionRequestSchemaQrc721 {
    ...
    pub request_details: Option<Box<crate::models::BurnRequestDetailsSchemaQrc721>>,
}

impl PrepareBurnTransactionRequestSchemaQrc721 {
    pub fn new(location: crate::models::Location, _type: Type, urgency: Urgency) -> PrepareBurnTransactionRequestSchemaQrc721 {
