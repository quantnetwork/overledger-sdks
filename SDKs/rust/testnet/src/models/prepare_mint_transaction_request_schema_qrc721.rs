...
pub struct PrepareMintTransactionRequestSchemaQrc721 {
    ...
    pub request_details: Option<Box<crate::models::MintRequestDetailsSchemaQrc721>>,
}

impl PrepareMintTransactionRequestSchemaQrc721 {
    pub fn new(location: crate::models::Location, _type: Type, urgency: Urgency) -> PrepareMintTransactionRequestSchemaQrc721 {
