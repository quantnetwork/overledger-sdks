...
pub struct MintRequestDetailsSchemaQrc721 {
    #[serde(rename = "beneficiary", skip_serializing_if = "Option::is_none")]
    pub beneficiary: Option<Box<crate::models::BeneficiaryMintSchemaQrc721>>,
...
impl MintRequestDetailsSchemaQrc721 {
    pub fn new() -> MintRequestDetailsSchemaQrc721 {
