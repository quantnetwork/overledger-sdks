...
pub struct PrepareApproveDebitTransactionRequestSchema {
    ...
    pub request_details: Option<Box<crate::models::ApproveRequestDetailsSchema>>,
}

impl PrepareApproveDebitTransactionRequestSchema {
    pub fn new(location: crate::models::Location, _type: Type, urgency: Urgency) -> PrepareApproveDebitTransactionRequestSchema {
