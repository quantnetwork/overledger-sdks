...
pub struct PrepareTransactionSmartContractInvokeRequestSchema {
    ...
    pub request_details: Option<Box<crate::models::SmartContractInvokeRequestDetailsSchema>>,
}

impl PrepareTransactionSmartContractInvokeRequestSchema {
    pub fn new(location: crate::models::Location, _type: Type, urgency: Urgency) -> PrepareTransactionSmartContractInvokeRequestSchema {
