...
pub struct PrepareAddSecondaryAccountRequestSchema {
    ...
    pub request_details: Option<Box<crate::models::AddSecondaryAccountRequestDetailsSchema>>,
}

impl PrepareAddSecondaryAccountRequestSchema {
    pub fn new(location: crate::models::Location, _type: Type, urgency: Urgency) -> PrepareAddSecondaryAccountRequestSchema {
