...
pub struct ReadApprovedAccountAllowanceRequestSchema {
...
impl ReadApprovedAccountAllowanceRequestSchema {
    pub fn new() -> ReadApprovedAccountAllowanceRequestSchema {
