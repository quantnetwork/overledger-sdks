...
pub struct BurnRequestDetailsSchemaQrc721 {
    #[serde(rename = "owner", skip_serializing_if = "Option::is_none")]
    pub owner: Option<Box<crate::models::OwnerBurnSchema>>,
    #[serde(rename = "overledgerSigningType", skip_serializing_if = "Option::is_none")]
    pub overledger_signing_type: Option<String>,
}

impl BurnRequestDetailsSchemaQrc721 {
    pub fn new() -> BurnRequestDetailsSchemaQrc721 {
