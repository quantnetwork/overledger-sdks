...
pub struct PrepareMintTransactionRequestSchemaQrc20 {
    ...
    pub request_details: Option<Box<crate::models::MintRequestDetailsSchemaQrc20>>,
}

impl PrepareMintTransactionRequestSchemaQrc20 {
    pub fn new(location: crate::models::Location, _type: Type, urgency: Urgency) -> PrepareMintTransactionRequestSchemaQrc20 {
