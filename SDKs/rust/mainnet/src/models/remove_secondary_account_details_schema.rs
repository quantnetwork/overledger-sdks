...
pub struct RemoveSecondaryAccountDetailsSchema {
    #[serde(rename = "owner", skip_serializing_if = "Option::is_none")]
    pub owner: Option<Box<crate::models::OwnerRemoveSecondarySchema>>,
    #[serde(rename = "additionalOwner", skip_serializing_if = "Option::is_none")]
    pub additional_owner: Option<Box<crate::models::AdditionalOwnerRemoveSecondarySchema>>,
...
impl RemoveSecondaryAccountDetailsSchema {
    pub fn new() -> RemoveSecondaryAccountDetailsSchema {
