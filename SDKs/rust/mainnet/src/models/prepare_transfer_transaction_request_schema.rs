...
pub struct PrepareTransferTransactionRequestSchema {
    ...
    pub request_details: Option<Box<crate::models::TransferRequestDetailsSchema>>,
}

impl PrepareTransferTransactionRequestSchema {
    pub fn new(location: crate::models::Location, _type: Type, urgency: Urgency) -> PrepareTransferTransactionRequestSchema {
