...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrepareAndExecuteSearchAddressBalanceResponse :  IEquatable<PrepareAndExecuteSearchAddressBalanceResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareAndExecuteSearchAddressBalanceResponse" /> class.
        /// </summary>
        /// <param name="balances">balances.</param>
        /// <param name="location">location.</param>
        /// <param name="timestamp">timestamp.</param>
        /// <param name="addressId">addressId.</param>
        public PrepareAndExecuteSearchAddressBalanceResponse(List<PrepareAndExecuteBalanceDetails> balances = default(List<PrepareAndExecuteBalanceDetails>), Location location = default(Location), string timestamp = default(string), string addressId = default(string))
        {
        ...
        public List<PrepareAndExecuteBalanceDetails> Balances { get; set; }
        ...
        {
            return this.Equals(input as PrepareAndExecuteSearchAddressBalanceResponse);
        }

        /// <summary>
        /// Returns true if PrepareAndExecuteSearchAddressBalanceResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PrepareAndExecuteSearchAddressBalanceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrepareAndExecuteSearchAddressBalanceResponse input)
        {
            if (input == null)
                return false;
