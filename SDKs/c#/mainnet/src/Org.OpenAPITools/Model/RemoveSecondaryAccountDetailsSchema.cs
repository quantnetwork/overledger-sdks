...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RemoveSecondaryAccountDetailsSchema :  IEquatable<RemoveSecondaryAccountDetailsSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveSecondaryAccountDetailsSchema" /> class.
        /// </summary>
        ...
        public RemoveSecondaryAccountDetailsSchema(OwnerRemoveSecondarySchema owner = default(OwnerRemoveSecondarySchema), AdditionalOwnerRemoveSecondarySchema additionalOwner = default(AdditionalOwnerRemoveSecondarySchema), string message = default(string), string overledgerSigningType = default(string))
        {
            this.Owner = owner;
        ...
        public OwnerRemoveSecondarySchema Owner { get; set; }

        /// <summary>
        /// Gets or Sets AdditionalOwner
        /// </summary>
        [DataMember(Name="additionalOwner", EmitDefaultValue=false)]
        public AdditionalOwnerRemoveSecondarySchema AdditionalOwner { get; set; }
        ...
        {
            return this.Equals(input as RemoveSecondaryAccountDetailsSchema);
        }

        /// <summary>
        /// Returns true if RemoveSecondaryAccountDetailsSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoveSecondaryAccountDetailsSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoveSecondaryAccountDetailsSchema input)
        {
            if (input == null)
                return false;
