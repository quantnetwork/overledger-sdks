...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TransferSchema :  IEquatable<TransferSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferSchema" /> class.
        /// </summary>
        /// <param name="tokenId">tokenId.</param>
        /// <param name="tokenName">tokenName.</param>
        public TransferSchema(string tokenId = default(string), string tokenName = default(string))
        {
        ...
        {
            return this.Equals(input as TransferSchema);
        }

        /// <summary>
        /// Returns true if TransferSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferSchema input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.TokenId != null && this.TokenId.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TokenId, length must be less than 50.", new [] { "TokenId" });
            }
            ...
            Regex regexTokenId = new Regex(@"^[a-zA-Z0-9_ ]{1,50}$", RegexOptions.CultureInvariant);
            ...
            if(this.TokenName != null && this.TokenName.Length > 50)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TokenName, length must be less than 50.", new [] { "TokenName" });
            }
            ...
            Regex regexTokenName = new Regex(@"^[a-zA-Z0-9_ ]{1,50}$", RegexOptions.CultureInvariant);
