...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Receiver :  IEquatable<Receiver>, IValidatableObject
    {
        /// <summary>
        ...
        public Receiver(string accountId = default(string), Transfer transfer = default(Transfer))
        {
