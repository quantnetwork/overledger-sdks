...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionUpdateResponse :  IEquatable<SubscriptionUpdateResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionUpdateResponse" /> class.
        /// </summary>
        /// <param name="subscriptionDetails">subscriptionDetails.</param>
        /// <param name="callbackUrl">callbackUrl.</param>
        /// <param name="subscriptionId">subscriptionId.</param>
        /// <param name="type">type.</param>
        public SubscriptionUpdateResponse(SubscriptionDetails subscriptionDetails = default(SubscriptionDetails), string callbackUrl = default(string), string subscriptionId = default(string), string type = default(string))
        {
        ...
        {
            return this.Equals(input as SubscriptionUpdateResponse);
        }

        /// <summary>
        /// Returns true if SubscriptionUpdateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionUpdateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionUpdateResponse input)
        {
            if (input == null)
                return false;
