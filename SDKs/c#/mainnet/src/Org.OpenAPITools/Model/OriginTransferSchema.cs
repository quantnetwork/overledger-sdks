...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OriginTransferSchema :  IEquatable<OriginTransferSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OriginTransferSchema" /> class.
        /// </summary>
        /// <param name="originId">originId.</param>
        public OriginTransferSchema(string originId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OriginTransferSchema {\n");
        ...
        {
            return this.Equals(input as OriginTransferSchema);
        }

        /// <summary>
        /// Returns true if OriginTransferSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of OriginTransferSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OriginTransferSchema input)
        {
            if (input == null)
                return false;
