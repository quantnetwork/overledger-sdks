...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListWebhookSubscriptionResponseSchema :  IEquatable<ListWebhookSubscriptionResponseSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListWebhookSubscriptionResponseSchema" /> class.
        /// </summary>
        ...
        /// <param name="subscribedTime">subscribedTime.</param>
        public ListWebhookSubscriptionResponseSchema(WebhookSubscriptionDetailsSchema subscriptionDetails = default(WebhookSubscriptionDetailsSchema), DateTime lastUpdatedTime = default(DateTime), string callbackUrl = default(string), string subscriptionId = default(string), string type = default(string), DateTime subscribedTime = default(DateTime))
        {
        ...
        public WebhookSubscriptionDetailsSchema SubscriptionDetails { get; set; }
        ...
        /// <summary>
        /// Gets or Sets SubscribedTime
        /// </summary>
        [DataMember(Name="subscribedTime", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SubscribedTime: ").Append(SubscribedTime).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ListWebhookSubscriptionResponseSchema);
        }

        /// <summary>
        /// Returns true if ListWebhookSubscriptionResponseSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of ListWebhookSubscriptionResponseSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListWebhookSubscriptionResponseSchema input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SubscribedTime == input.SubscribedTime ||
                    (this.SubscribedTime != null &&
                    this.SubscribedTime.Equals(input.SubscribedTime))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SubscribedTime != null)
                    hashCode = hashCode * 59 + this.SubscribedTime.GetHashCode();
                return hashCode;
            }
        }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.Type != null && this.Type.Length > 24)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Type, length must be less than 24.", new [] { "Type" });
            }
