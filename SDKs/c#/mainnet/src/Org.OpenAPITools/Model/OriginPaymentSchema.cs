...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class OriginPaymentSchema :  IEquatable<OriginPaymentSchema>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as OriginPaymentSchema);
        }

        /// <summary>
        /// Returns true if OriginPaymentSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of OriginPaymentSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OriginPaymentSchema input)
        {
            if (input == null)
                return false;
