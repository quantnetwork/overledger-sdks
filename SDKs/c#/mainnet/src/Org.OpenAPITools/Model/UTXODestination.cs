...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UTXODestination :  IEquatable<UTXODestination>, IValidatableObject
    {
        /// <summary>
        ...
        public UTXOSmartContract SmartContract { get; set; }
        ...
        {
            return this.Equals(input as UTXODestination);
        }

        /// <summary>
        /// Returns true if UTXODestination instances are equal
        /// </summary>
        /// <param name="input">Instance of UTXODestination to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UTXODestination input)
        {
            if (input == null)
                return false;
