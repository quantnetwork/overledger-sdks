...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateWebhookSubscriptionRequestSchema :  IEquatable<UpdateWebhookSubscriptionRequestSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateWebhookSubscriptionRequestSchema" /> class.
        /// </summary>
        /// <param name="statusUpdate">statusUpdate.</param>
        /// <param name="callbackUrl">callbackUrl.</param>
        public UpdateWebhookSubscriptionRequestSchema(WebhookStatusUpdateSchema statusUpdate = default(WebhookStatusUpdateSchema), string callbackUrl = default(string))
        {
        ...
        public WebhookStatusUpdateSchema StatusUpdate { get; set; }
        ...
        {
            return this.Equals(input as UpdateWebhookSubscriptionRequestSchema);
        }

        /// <summary>
        /// Returns true if UpdateWebhookSubscriptionRequestSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateWebhookSubscriptionRequestSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateWebhookSubscriptionRequestSchema input)
        {
            if (input == null)
                return false;
