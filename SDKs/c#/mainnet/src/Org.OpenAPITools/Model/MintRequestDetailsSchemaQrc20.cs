...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MintRequestDetailsSchemaQrc20 :  IEquatable<MintRequestDetailsSchemaQrc20>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MintRequestDetailsSchemaQrc20" /> class.
        /// </summary>
        ...
        public MintRequestDetailsSchemaQrc20(CreatorMintSchema creator = default(CreatorMintSchema), BeneficiaryMintSchemaQrc20 beneficiary = default(BeneficiaryMintSchemaQrc20), string message = default(string), string overledgerSigningType = default(string))
        {
        ...
        public BeneficiaryMintSchemaQrc20 Beneficiary { get; set; }
        ...
        {
            return this.Equals(input as MintRequestDetailsSchemaQrc20);
        }

        /// <summary>
        /// Returns true if MintRequestDetailsSchemaQrc20 instances are equal
        /// </summary>
        /// <param name="input">Instance of MintRequestDetailsSchemaQrc20 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MintRequestDetailsSchemaQrc20 input)
        {
            if (input == null)
                return false;
