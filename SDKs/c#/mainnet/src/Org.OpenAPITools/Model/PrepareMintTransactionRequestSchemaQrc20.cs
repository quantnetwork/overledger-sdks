...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrepareMintTransactionRequestSchemaQrc20 :  IEquatable<PrepareMintTransactionRequestSchemaQrc20>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareMintTransactionRequestSchemaQrc20" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PrepareMintTransactionRequestSchemaQrc20() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareMintTransactionRequestSchemaQrc20" /> class.
        /// </summary>
        ...
        public PrepareMintTransactionRequestSchemaQrc20(Location location = default(Location), TypeEnum type = default(TypeEnum), UrgencyEnum urgency = default(UrgencyEnum), MintRequestDetailsSchemaQrc20 requestDetails = default(MintRequestDetailsSchemaQrc20))
        {
            // to ensure "location" is required (not null)
            if (location == null)
            {
                throw new InvalidDataException("location is a required property for PrepareMintTransactionRequestSchemaQrc20 and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PrepareMintTransactionRequestSchemaQrc20 and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (urgency == null)
            {
                throw new InvalidDataException("urgency is a required property for PrepareMintTransactionRequestSchemaQrc20 and cannot be null");
            }
            else
            {
        ...
        public MintRequestDetailsSchemaQrc20 RequestDetails { get; set; }
        ...
        {
            return this.Equals(input as PrepareMintTransactionRequestSchemaQrc20);
        }

        /// <summary>
        /// Returns true if PrepareMintTransactionRequestSchemaQrc20 instances are equal
        /// </summary>
        /// <param name="input">Instance of PrepareMintTransactionRequestSchemaQrc20 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrepareMintTransactionRequestSchemaQrc20 input)
        {
            if (input == null)
                return false;
