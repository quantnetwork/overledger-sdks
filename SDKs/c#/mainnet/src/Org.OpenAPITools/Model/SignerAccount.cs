...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SignerAccount :  IEquatable<SignerAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SignerAccount" /> class.
        /// </summary>
        /// <param name="accountId">accountId.</param>
        public SignerAccount(string accountId = default(string))
        {
        ...
        {
            return this.Equals(input as SignerAccount);
        }

        /// <summary>
        /// Returns true if SignerAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of SignerAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignerAccount input)
        {
            if (input == null)
                return false;
