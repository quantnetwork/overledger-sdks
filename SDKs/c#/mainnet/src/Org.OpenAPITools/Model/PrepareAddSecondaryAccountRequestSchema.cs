...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrepareAddSecondaryAccountRequestSchema :  IEquatable<PrepareAddSecondaryAccountRequestSchema>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareAddSecondaryAccountRequestSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PrepareAddSecondaryAccountRequestSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareAddSecondaryAccountRequestSchema" /> class.
        /// </summary>
        ...
        public PrepareAddSecondaryAccountRequestSchema(Location location = default(Location), TypeEnum type = default(TypeEnum), UrgencyEnum urgency = default(UrgencyEnum), AddSecondaryAccountRequestDetailsSchema requestDetails = default(AddSecondaryAccountRequestDetailsSchema))
        {
            // to ensure "location" is required (not null)
            if (location == null)
            {
                throw new InvalidDataException("location is a required property for PrepareAddSecondaryAccountRequestSchema and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PrepareAddSecondaryAccountRequestSchema and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (urgency == null)
            {
                throw new InvalidDataException("urgency is a required property for PrepareAddSecondaryAccountRequestSchema and cannot be null");
            }
            else
            {
        ...
        public AddSecondaryAccountRequestDetailsSchema RequestDetails { get; set; }
        ...
        {
            return this.Equals(input as PrepareAddSecondaryAccountRequestSchema);
        }

        /// <summary>
        /// Returns true if PrepareAddSecondaryAccountRequestSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of PrepareAddSecondaryAccountRequestSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrepareAddSecondaryAccountRequestSchema input)
        {
            if (input == null)
                return false;
