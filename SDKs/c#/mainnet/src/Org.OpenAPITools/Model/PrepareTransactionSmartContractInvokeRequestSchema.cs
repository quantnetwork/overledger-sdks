...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrepareTransactionSmartContractInvokeRequestSchema :  IEquatable<PrepareTransactionSmartContractInvokeRequestSchema>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareTransactionSmartContractInvokeRequestSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PrepareTransactionSmartContractInvokeRequestSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareTransactionSmartContractInvokeRequestSchema" /> class.
        /// </summary>
        ...
        public PrepareTransactionSmartContractInvokeRequestSchema(Location location = default(Location), TypeEnum type = default(TypeEnum), UrgencyEnum urgency = default(UrgencyEnum), SmartContractInvokeRequestDetailsSchema requestDetails = default(SmartContractInvokeRequestDetailsSchema))
        {
            // to ensure "location" is required (not null)
            if (location == null)
            {
                throw new InvalidDataException("location is a required property for PrepareTransactionSmartContractInvokeRequestSchema and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PrepareTransactionSmartContractInvokeRequestSchema and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (urgency == null)
            {
                throw new InvalidDataException("urgency is a required property for PrepareTransactionSmartContractInvokeRequestSchema and cannot be null");
            }
            else
            {
        ...
        public SmartContractInvokeRequestDetailsSchema RequestDetails { get; set; }
        ...
        {
            return this.Equals(input as PrepareTransactionSmartContractInvokeRequestSchema);
        }

        /// <summary>
        /// Returns true if PrepareTransactionSmartContractInvokeRequestSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of PrepareTransactionSmartContractInvokeRequestSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrepareTransactionSmartContractInvokeRequestSchema input)
        {
            if (input == null)
                return false;
