...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MintSchemaQrc721 :  IEquatable<MintSchemaQrc721>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MintSchemaQrc721" /> class.
        /// </summary>
        ...
        public MintSchemaQrc721(string tokenId = default(string), string tokenName = default(string), string metadata = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MintSchemaQrc721 {\n");
        ...
        {
            return this.Equals(input as MintSchemaQrc721);
        }

        /// <summary>
        /// Returns true if MintSchemaQrc721 instances are equal
        /// </summary>
        /// <param name="input">Instance of MintSchemaQrc721 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MintSchemaQrc721 input)
        {
            if (input == null)
                return false;
