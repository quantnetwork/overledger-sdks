...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrepareBurnTransactionRequestSchema :  IEquatable<PrepareBurnTransactionRequestSchema>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareBurnTransactionRequestSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PrepareBurnTransactionRequestSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareBurnTransactionRequestSchema" /> class.
        /// </summary>
        ...
        public PrepareBurnTransactionRequestSchema(Location location = default(Location), TypeEnum type = default(TypeEnum), UrgencyEnum urgency = default(UrgencyEnum), BurnRequestDetailsSchema requestDetails = default(BurnRequestDetailsSchema))
        {
            // to ensure "location" is required (not null)
            if (location == null)
            {
                throw new InvalidDataException("location is a required property for PrepareBurnTransactionRequestSchema and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PrepareBurnTransactionRequestSchema and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (urgency == null)
            {
                throw new InvalidDataException("urgency is a required property for PrepareBurnTransactionRequestSchema and cannot be null");
            }
            else
            {
        ...
        public BurnRequestDetailsSchema RequestDetails { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PrepareBurnTransactionRequestSchema {\n");
        ...
        {
            return this.Equals(input as PrepareBurnTransactionRequestSchema);
        }

        /// <summary>
        /// Returns true if PrepareBurnTransactionRequestSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of PrepareBurnTransactionRequestSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrepareBurnTransactionRequestSchema input)
        {
            if (input == null)
                return false;
