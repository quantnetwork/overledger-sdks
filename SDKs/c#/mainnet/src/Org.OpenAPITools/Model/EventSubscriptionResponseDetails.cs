...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EventSubscriptionResponseDetails :  IEquatable<EventSubscriptionResponseDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EventSubscriptionResponseDetails" /> class.
        /// </summary>
        /// <param name="subscriptionId">subscriptionId.</param>
        /// <param name="callbackUrl">callbackUrl.</param>
        /// <param name="createdDate">createdDate.</param>
        public EventSubscriptionResponseDetails(string subscriptionId = default(string), string callbackUrl = default(string), string createdDate = default(string))
        {
        ...
        {
            return this.Equals(input as EventSubscriptionResponseDetails);
        }

        /// <summary>
        /// Returns true if EventSubscriptionResponseDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of EventSubscriptionResponseDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventSubscriptionResponseDetails input)
        {
            if (input == null)
                return false;
