...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdditionalOwnerRemoveSecondarySchema :  IEquatable<AdditionalOwnerRemoveSecondarySchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalOwnerRemoveSecondarySchema" /> class.
        /// </summary>
        /// <param name="accountId">Unique Identifier of the owner.</param>
        public AdditionalOwnerRemoveSecondarySchema(string accountId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdditionalOwnerRemoveSecondarySchema {\n");
        ...
        {
            return this.Equals(input as AdditionalOwnerRemoveSecondarySchema);
        }

        /// <summary>
        /// Returns true if AdditionalOwnerRemoveSecondarySchema instances are equal
        /// </summary>
        /// <param name="input">Instance of AdditionalOwnerRemoveSecondarySchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdditionalOwnerRemoveSecondarySchema input)
        {
            if (input == null)
                return false;
