...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionDeletionResponse :  IEquatable<SubscriptionDeletionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionDeletionResponse" /> class.
        /// </summary>
        /// <param name="subscriptionDetails">subscriptionDetails.</param>
        /// <param name="callbackUrl">callbackUrl.</param>
        /// <param name="subscriptionId">subscriptionId.</param>
        /// <param name="type">type.</param>
        public SubscriptionDeletionResponse(SubscriptionDetails subscriptionDetails = default(SubscriptionDetails), string callbackUrl = default(string), string subscriptionId = default(string), string type = default(string))
        {
        ...
        {
            return this.Equals(input as SubscriptionDeletionResponse);
        }

        /// <summary>
        /// Returns true if SubscriptionDeletionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriptionDeletionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionDeletionResponse input)
        {
            if (input == null)
                return false;
