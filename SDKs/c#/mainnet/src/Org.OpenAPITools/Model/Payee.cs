...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Payee :  IEquatable<Payee>, IValidatableObject
    {
        ...
        public Payee(Payment payment = default(Payment), string payeeId = default(string))
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            Regex regexPayeeId = new Regex(@"^[a-zA-Z0-9:,\/.=\\-\\s]{1,500}", RegexOptions.CultureInvariant);
