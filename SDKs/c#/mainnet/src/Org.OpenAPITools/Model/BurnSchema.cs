...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BurnSchema :  IEquatable<BurnSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BurnSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BurnSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BurnSchema" /> class.
        /// </summary>
        /// <param name="amount">The amount of a currency (required).</param>
        /// <param name="unit">The unit of this currency/token.</param>
        public BurnSchema(string amount = default(string), string unit = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for BurnSchema and cannot be null");
            }
            else
            {
                this.Amount = amount;
        ...
        {
            return this.Equals(input as BurnSchema);
        }

        /// <summary>
        /// Returns true if BurnSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of BurnSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BurnSchema input)
        {
            if (input == null)
                return false;
