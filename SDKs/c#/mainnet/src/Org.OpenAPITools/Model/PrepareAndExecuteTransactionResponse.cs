...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrepareAndExecuteTransactionResponse :  IEquatable<PrepareAndExecuteTransactionResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember(Name="preparationTransactionSearchResponse", EmitDefaultValue=false)]
        public PrepareTransactionResponse PreparationTransactionSearchResponse { get; set; }

        /// <summary>
        /// Gets or Sets ExecutionTransactionSearchResponse
        /// </summary>
        [DataMember(Name="executionTransactionSearchResponse", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as PrepareAndExecuteTransactionResponse);
        }

        /// <summary>
        /// Returns true if PrepareAndExecuteTransactionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PrepareAndExecuteTransactionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrepareAndExecuteTransactionResponse input)
        {
            if (input == null)
                return false;
