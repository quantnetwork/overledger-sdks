...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApproveRequestDetailsSchema :  IEquatable<ApproveRequestDetailsSchema>, IValidatableObject
    {
        /// <summary>
        ...
        public List<PayeeCreditSchema> Mandate { get; set; }
        ...
        {
            return this.Equals(input as ApproveRequestDetailsSchema);
        }

        /// <summary>
        /// Returns true if ApproveRequestDetailsSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of ApproveRequestDetailsSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApproveRequestDetailsSchema input)
        {
            if (input == null)
                return false;
