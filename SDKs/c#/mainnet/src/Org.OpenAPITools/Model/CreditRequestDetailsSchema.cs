...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreditRequestDetailsSchema :  IEquatable<CreditRequestDetailsSchema>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CreditRequestDetailsSchema);
        }

        /// <summary>
        /// Returns true if CreditRequestDetailsSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditRequestDetailsSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditRequestDetailsSchema input)
        {
            if (input == null)
                return false;
