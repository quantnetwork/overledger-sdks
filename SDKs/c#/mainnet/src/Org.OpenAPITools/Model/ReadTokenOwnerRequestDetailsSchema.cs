...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReadTokenOwnerRequestDetailsSchema :  IEquatable<ReadTokenOwnerRequestDetailsSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadTokenOwnerRequestDetailsSchema" /> class.
        /// </summary>
        /// <param name="tokenId">Id of the token.</param>
        /// <param name="tokenName">Name of the token.</param>
        public ReadTokenOwnerRequestDetailsSchema(string tokenId = default(string), string tokenName = default(string))
        {
        ...
        {
            return this.Equals(input as ReadTokenOwnerRequestDetailsSchema);
        }

        /// <summary>
        /// Returns true if ReadTokenOwnerRequestDetailsSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadTokenOwnerRequestDetailsSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadTokenOwnerRequestDetailsSchema input)
        {
            if (input == null)
                return false;
