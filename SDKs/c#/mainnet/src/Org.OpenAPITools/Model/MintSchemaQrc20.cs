...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MintSchemaQrc20 :  IEquatable<MintSchemaQrc20>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MintSchemaQrc20" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MintSchemaQrc20() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MintSchemaQrc20" /> class.
        /// </summary>
        /// <param name="amount">The amount of a currency (required).</param>
        /// <param name="unit">The unit of this currency/token.</param>
        public MintSchemaQrc20(string amount = default(string), string unit = default(string))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for MintSchemaQrc20 and cannot be null");
            }
            else
            {
                this.Amount = amount;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MintSchemaQrc20 {\n");
        ...
        {
            return this.Equals(input as MintSchemaQrc20);
        }

        /// <summary>
        /// Returns true if MintSchemaQrc20 instances are equal
        /// </summary>
        /// <param name="input">Instance of MintSchemaQrc20 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MintSchemaQrc20 input)
        {
            if (input == null)
                return false;
