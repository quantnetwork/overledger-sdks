...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrepareBurnTransactionRequestSchemaQrc721 :  IEquatable<PrepareBurnTransactionRequestSchemaQrc721>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareBurnTransactionRequestSchemaQrc721" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PrepareBurnTransactionRequestSchemaQrc721() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareBurnTransactionRequestSchemaQrc721" /> class.
        /// </summary>
        ...
        public PrepareBurnTransactionRequestSchemaQrc721(Location location = default(Location), TypeEnum type = default(TypeEnum), UrgencyEnum urgency = default(UrgencyEnum), BurnRequestDetailsSchemaQrc721 requestDetails = default(BurnRequestDetailsSchemaQrc721))
        {
            // to ensure "location" is required (not null)
            if (location == null)
            {
                throw new InvalidDataException("location is a required property for PrepareBurnTransactionRequestSchemaQrc721 and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PrepareBurnTransactionRequestSchemaQrc721 and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (urgency == null)
            {
                throw new InvalidDataException("urgency is a required property for PrepareBurnTransactionRequestSchemaQrc721 and cannot be null");
            }
            else
            {
        ...
        public BurnRequestDetailsSchemaQrc721 RequestDetails { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PrepareBurnTransactionRequestSchemaQrc721 {\n");
        ...
        {
            return this.Equals(input as PrepareBurnTransactionRequestSchemaQrc721);
        }

        /// <summary>
        /// Returns true if PrepareBurnTransactionRequestSchemaQrc721 instances are equal
        /// </summary>
        /// <param name="input">Instance of PrepareBurnTransactionRequestSchemaQrc721 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrepareBurnTransactionRequestSchemaQrc721 input)
        {
            if (input == null)
                return false;
