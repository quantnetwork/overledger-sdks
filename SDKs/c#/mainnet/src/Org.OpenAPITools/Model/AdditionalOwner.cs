...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdditionalOwner :  IEquatable<AdditionalOwner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdditionalOwner" /> class.
        /// </summary>
        /// <param name="accountId">accountId.</param>
        public AdditionalOwner(string accountId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdditionalOwner {\n");
        ...
        {
            return this.Equals(input as AdditionalOwner);
        }

        /// <summary>
        /// Returns true if AdditionalOwner instances are equal
        /// </summary>
        /// <param name="input">Instance of AdditionalOwner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdditionalOwner input)
        {
            if (input == null)
                return false;
