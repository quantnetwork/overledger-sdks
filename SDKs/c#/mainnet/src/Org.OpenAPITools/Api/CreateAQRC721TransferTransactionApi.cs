...
namespace Org.OpenAPITools.Api
{
    ...
    /// </summary>
    public interface ICreateAQRC721TransferTransactionApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class CreateAQRC721TransferTransactionApi : ICreateAQRC721TransferTransactionApi
    {
        private Org.OpenAPITools.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAQRC721TransferTransactionApi"/> class.
        /// </summary>
        /// <returns></returns>
        public CreateAQRC721TransferTransactionApi(String basePath)
        {
        ...
        /// <returns></returns>
        public CreateAQRC721TransferTransactionApi(Org.OpenAPITools.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Prepare a QRC721 token transfer transaction for signing Transforms a transaction request ready to be signed and returns a request ID for executing. The supported transaction type is “Create Transfer” which will allow you to transfer a QRC721 token to another specified account. Successfully prepared transactions can then be executed using the /execution/transaction API.
        /// </summary>
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization"></param>
        /// <param name="preparePaymentTransactionRequestSchema"></param>
        ...
        public ApiResponse<PrepareTransactionResponse> PrepareTransactionRequestWithHttpInfo (string authorization, PreparePaymentTransactionRequestSchema preparePaymentTransactionRequestSchema)
        {
            ...
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling CreateAQRC721TransferTransactionApi->PrepareTransactionRequest");
            ...
            if (preparePaymentTransactionRequestSchema == null)
                throw new ApiException(400, "Missing required parameter 'preparePaymentTransactionRequestSchema' when calling CreateAQRC721TransferTransactionApi->PrepareTransactionRequest");

            var localVarPath = "/v2/tokenise/preparation/transaction/qrc721/transfer";
