...
namespace Org.OpenAPITools.Api
{
    ...
    /// </summary>
    public interface ISubscribeToQRC20TokenSupplyChangesApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SubscribeToQRC20TokenSupplyChangesApi : ISubscribeToQRC20TokenSupplyChangesApi
    {
        private Org.OpenAPITools.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribeToQRC20TokenSupplyChangesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public SubscribeToQRC20TokenSupplyChangesApi(String basePath)
        {
        ...
        /// <returns></returns>
        public SubscribeToQRC20TokenSupplyChangesApi(Org.OpenAPITools.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<EventSubscriptionResponse> SubscribeSupplyEventWithHttpInfo (string authorization, string flowtype, Object body)
        {
            ...
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling SubscribeToQRC20TokenSupplyChangesApi->SubscribeSupplyEvent");
            // verify the required parameter 'flowtype' is set
            if (flowtype == null)
                throw new ApiException(400, "Missing required parameter 'flowtype' when calling SubscribeToQRC20TokenSupplyChangesApi->SubscribeSupplyEvent");
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling SubscribeToQRC20TokenSupplyChangesApi->SubscribeSupplyEvent");
