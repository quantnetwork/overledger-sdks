...
namespace Org.OpenAPITools.Api
{
    ...
    /// </summary>
    public interface IManageQRC20TokenSupplyApi : IApiAccessor
    {
        ...
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization"></param>
        /// <param name="prepareMintTransactionRequestSchemaQrc20"></param>
        ...
        ApiResponse<PrepareTransactionResponse> PrepareSupplyRequest1WithHttpInfo (string authorization, PrepareMintTransactionRequestSchemaQrc20 prepareMintTransactionRequestSchemaQrc20);
        ...
        System.Threading.Tasks.Task<PrepareTransactionResponse> PrepareSupplyRequest1Async (string authorization, PrepareMintTransactionRequestSchemaQrc20 prepareMintTransactionRequestSchemaQrc20, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PrepareTransactionResponse>> PrepareSupplyRequest1WithHttpInfoAsync (string authorization, PrepareMintTransactionRequestSchemaQrc20 prepareMintTransactionRequestSchemaQrc20, CancellationToken cancellationToken = default(CancellationToken));
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ManageQRC20TokenSupplyApi : IManageQRC20TokenSupplyApi
    {
        private Org.OpenAPITools.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ManageQRC20TokenSupplyApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ManageQRC20TokenSupplyApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ManageQRC20TokenSupplyApi(Org.OpenAPITools.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<ExecuteTransactionResponse> ExecutePreparedRequestTransactionWithHttpInfo (string authorization, ExecuteTransactionRequest executeTransactionRequest)
        {
            ...
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling ManageQRC20TokenSupplyApi->ExecutePreparedRequestTransaction");
            // verify the required parameter 'executeTransactionRequest' is set
            if (executeTransactionRequest == null)
                throw new ApiException(400, "Missing required parameter 'executeTransactionRequest' when calling ManageQRC20TokenSupplyApi->ExecutePreparedRequestTransaction");
        ...
        /// <summary>
        /// Prepare a request to manage QRC20 token supply Transforms a transaction request to manage QRC20 token supply ready to be signed and returns a request ID for executing. The supported types for this API are “Mint Tokens”, which will allow you to issue more tokens for your QRC20 token, and \&quot;Burn Tokens\&quot; which will allow you to destroy your QRC20 tokens. Successfully prepared transactions can then be executed using the /execution/transaction API.
        /// </summary>
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="authorization"></param>
        /// <param name="prepareMintTransactionRequestSchemaQrc20"></param>
        /// <returns>PrepareTransactionResponse</returns>
        public PrepareTransactionResponse PrepareSupplyRequest1 (string authorization, PrepareMintTransactionRequestSchemaQrc20 prepareMintTransactionRequestSchemaQrc20)
        {
             ApiResponse<PrepareTransactionResponse> localVarResponse = PrepareSupplyRequest1WithHttpInfo(authorization, prepareMintTransactionRequestSchemaQrc20);
             return localVarResponse.Data;
        }
        ...
        /// <param name="prepareMintTransactionRequestSchemaQrc20"></param>
        /// <returns>ApiResponse of PrepareTransactionResponse</returns>
        public ApiResponse<PrepareTransactionResponse> PrepareSupplyRequest1WithHttpInfo (string authorization, PrepareMintTransactionRequestSchemaQrc20 prepareMintTransactionRequestSchemaQrc20)
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling ManageQRC20TokenSupplyApi->PrepareSupplyRequest1");
            ...
            if (prepareMintTransactionRequestSchemaQrc20 == null)
                throw new ApiException(400, "Missing required parameter 'prepareMintTransactionRequestSchemaQrc20' when calling ManageQRC20TokenSupplyApi->PrepareSupplyRequest1");

            var localVarPath = "/v2/preparation/supply";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (authorization != null) localVarHeaderParams.Add("Authorization", this.Configuration.ApiClient.ParameterToString(authorization)); // header parameter
            if (prepareMintTransactionRequestSchemaQrc20 != null && prepareMintTransactionRequestSchemaQrc20.GetType() != typeof(byte[]))
            {
                localVarPostBody = this.Configuration.ApiClient.Serialize(prepareMintTransactionRequestSchemaQrc20); // http body (model) parameter
            }
            else
            {
                localVarPostBody = prepareMintTransactionRequestSchemaQrc20; // byte array
            }
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PrepareSupplyRequest1", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of PrepareTransactionResponse</returns>
        public async System.Threading.Tasks.Task<PrepareTransactionResponse> PrepareSupplyRequest1Async (string authorization, PrepareMintTransactionRequestSchemaQrc20 prepareMintTransactionRequestSchemaQrc20, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<PrepareTransactionResponse> localVarResponse = await PrepareSupplyRequest1WithHttpInfoAsync(authorization, prepareMintTransactionRequestSchemaQrc20, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (PrepareTransactionResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PrepareTransactionResponse>> PrepareSupplyRequest1WithHttpInfoAsync (string authorization, PrepareMintTransactionRequestSchemaQrc20 prepareMintTransactionRequestSchemaQrc20, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'authorization' is set
            if (authorization == null)
                throw new ApiException(400, "Missing required parameter 'authorization' when calling ManageQRC20TokenSupplyApi->PrepareSupplyRequest1");
