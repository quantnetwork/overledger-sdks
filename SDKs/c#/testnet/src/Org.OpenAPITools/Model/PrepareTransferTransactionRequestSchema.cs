...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PrepareTransferTransactionRequestSchema :  IEquatable<PrepareTransferTransactionRequestSchema>, IValidatableObject
    {
        ...
        protected PrepareTransferTransactionRequestSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareTransferTransactionRequestSchema" /> class.
        /// </summary>
        ...
        public PrepareTransferTransactionRequestSchema(Location location = default(Location), TypeEnum type = default(TypeEnum), UrgencyEnum urgency = default(UrgencyEnum), TransferRequestDetailsSchema requestDetails = default(TransferRequestDetailsSchema))
        {
            // to ensure "location" is required (not null)
            if (location == null)
            {
                throw new InvalidDataException("location is a required property for PrepareTransferTransactionRequestSchema and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PrepareTransferTransactionRequestSchema and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (urgency == null)
            {
                throw new InvalidDataException("urgency is a required property for PrepareTransferTransactionRequestSchema and cannot be null");
            }
            else
            {
