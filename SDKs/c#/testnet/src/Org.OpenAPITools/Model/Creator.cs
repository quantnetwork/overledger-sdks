...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Creator :  IEquatable<Creator>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Creator" /> class.
        /// </summary>
        /// <param name="accountId">accountId.</param>
        public Creator(string accountId = default(string))
        {
        ...
        {
            return this.Equals(input as Creator);
        }

        /// <summary>
        /// Returns true if Creator instances are equal
        /// </summary>
        /// <param name="input">Instance of Creator to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Creator input)
        {
            if (input == null)
                return false;
