...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ReadApprovedAccountRequestDetailsSchema :  IEquatable<ReadApprovedAccountRequestDetailsSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReadApprovedAccountRequestDetailsSchema" /> class.
        /// </summary>
        /// <param name="tokenId">Id of the token.</param>
        /// <param name="tokenName">Name of the token.</param>
        public ReadApprovedAccountRequestDetailsSchema(string tokenId = default(string), string tokenName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReadApprovedAccountRequestDetailsSchema {\n");
        ...
        {
            return this.Equals(input as ReadApprovedAccountRequestDetailsSchema);
        }

        /// <summary>
        /// Returns true if ReadApprovedAccountRequestDetailsSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of ReadApprovedAccountRequestDetailsSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReadApprovedAccountRequestDetailsSchema input)
        {
            if (input == null)
                return false;
