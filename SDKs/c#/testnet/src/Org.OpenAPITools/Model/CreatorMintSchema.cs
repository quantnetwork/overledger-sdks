...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreatorMintSchema :  IEquatable<CreatorMintSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreatorMintSchema" /> class.
        /// </summary>
        /// <param name="accountId">Unique Identifier of the creator.</param>
        public CreatorMintSchema(string accountId = default(string))
        {
        ...
        /// </summary>
        /// <value>Unique Identifier of the creator</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreatorMintSchema {\n");
        ...
        {
            return this.Equals(input as CreatorMintSchema);
        }

        /// <summary>
        /// Returns true if CreatorMintSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of CreatorMintSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreatorMintSchema input)
        {
            if (input == null)
                return false;
