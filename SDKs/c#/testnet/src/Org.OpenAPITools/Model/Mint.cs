...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Mint :  IEquatable<Mint>, IValidatableObject
    {
        ...
        public Mint(string tokenName = default(string), string amount = default(string), string unit = default(string), string metadata = default(string), string tokenId = default(string))
        {
