...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateSubscriptionRequestSchema :  IEquatable<UpdateSubscriptionRequestSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSubscriptionRequestSchema" /> class.
        /// </summary>
        /// <param name="statusUpdate">statusUpdate.</param>
        /// <param name="callbackUrl">callbackUrl.</param>
        public UpdateSubscriptionRequestSchema(StatusUpdateSchema statusUpdate = default(StatusUpdateSchema), string callbackUrl = default(string))
        {
        ...
        {
            return this.Equals(input as UpdateSubscriptionRequestSchema);
        }

        /// <summary>
        /// Returns true if UpdateSubscriptionRequestSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateSubscriptionRequestSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateSubscriptionRequestSchema input)
        {
            if (input == null)
                return false;
