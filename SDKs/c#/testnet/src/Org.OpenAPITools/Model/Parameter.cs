...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Parameter :  IEquatable<Parameter>, IValidatableObject
    {
        ...
        public Parameter(string type = default(string), Object value = default(Object), string key = default(string))
        {
            this.Type = type;
            this.Value = value;
            this.Key = key;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Key (string) pattern
            Regex regexKey = new Regex(@"^[A-Za-z0-9]{1,20}$", RegexOptions.CultureInvariant);
