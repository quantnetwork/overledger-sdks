...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PreparePaymentTransactionRequestSchema :  IEquatable<PreparePaymentTransactionRequestSchema>, IValidatableObject
    {
        ...
        protected PreparePaymentTransactionRequestSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PreparePaymentTransactionRequestSchema" /> class.
        /// </summary>
        ...
        /// <param name="requestDetails">requestDetails (required).</param>
        public PreparePaymentTransactionRequestSchema(Location location = default(Location), TypeEnum type = default(TypeEnum), UrgencyEnum urgency = default(UrgencyEnum), PaymentRequestDetailsSchema requestDetails = default(PaymentRequestDetailsSchema))
        {
            // to ensure "location" is required (not null)
            if (location == null)
            {
                throw new InvalidDataException("location is a required property for PreparePaymentTransactionRequestSchema and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PreparePaymentTransactionRequestSchema and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (urgency == null)
            {
                throw new InvalidDataException("urgency is a required property for PreparePaymentTransactionRequestSchema and cannot be null");
            }
            else
            {
            ...
            // to ensure "requestDetails" is required (not null)
            if (requestDetails == null)
            {
                throw new InvalidDataException("requestDetails is a required property for PreparePaymentTransactionRequestSchema and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="requestDetails", EmitDefaultValue=true)]
