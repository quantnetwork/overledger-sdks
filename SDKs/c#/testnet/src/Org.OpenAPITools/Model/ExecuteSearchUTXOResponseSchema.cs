...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExecuteSearchUTXOResponseSchema :  IEquatable<ExecuteSearchUTXOResponseSchema>, IValidatableObject
    {
        /// <summary>
        ...
        public List<UTXODestination> Destination { get; set; }
        ...
        public UTXONativeData NativeData { get; set; }
        ...
        {
            return this.Equals(input as ExecuteSearchUTXOResponseSchema);
        }

        /// <summary>
        /// Returns true if ExecuteSearchUTXOResponseSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of ExecuteSearchUTXOResponseSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExecuteSearchUTXOResponseSchema input)
        {
            if (input == null)
                return false;
