...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SmartContractSearchSchema :  IEquatable<SmartContractSearchSchema>, IValidatableObject
    {
        ...
        public SmartContractSearchSchema(string smartContractId = default(string), SmartContractSearchFunctionSchema function = default(SmartContractSearchFunctionSchema))
        {
