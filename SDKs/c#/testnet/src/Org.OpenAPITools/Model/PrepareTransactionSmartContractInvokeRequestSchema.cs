...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PrepareTransactionSmartContractInvokeRequestSchema :  IEquatable<PrepareTransactionSmartContractInvokeRequestSchema>, IValidatableObject
    {
        ...
        public PrepareTransactionSmartContractInvokeRequestSchema(string urgency = default(string), SmartContractInvokeRequestDetailsSchema requestDetails = default(SmartContractInvokeRequestDetailsSchema), Location location = default(Location), string type = default(string))
        {
