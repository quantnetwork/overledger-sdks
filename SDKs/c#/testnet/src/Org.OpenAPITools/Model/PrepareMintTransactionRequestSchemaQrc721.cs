...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrepareMintTransactionRequestSchemaQrc721 :  IEquatable<PrepareMintTransactionRequestSchemaQrc721>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareMintTransactionRequestSchemaQrc721" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PrepareMintTransactionRequestSchemaQrc721() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PrepareMintTransactionRequestSchemaQrc721" /> class.
        /// </summary>
        ...
        public PrepareMintTransactionRequestSchemaQrc721(Location location = default(Location), TypeEnum type = default(TypeEnum), UrgencyEnum urgency = default(UrgencyEnum), MintRequestDetailsSchemaQrc721 requestDetails = default(MintRequestDetailsSchemaQrc721))
        {
            // to ensure "location" is required (not null)
            if (location == null)
            {
                throw new InvalidDataException("location is a required property for PrepareMintTransactionRequestSchemaQrc721 and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PrepareMintTransactionRequestSchemaQrc721 and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (urgency == null)
            {
                throw new InvalidDataException("urgency is a required property for PrepareMintTransactionRequestSchemaQrc721 and cannot be null");
            }
            else
            {
        ...
        public MintRequestDetailsSchemaQrc721 RequestDetails { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PrepareMintTransactionRequestSchemaQrc721 {\n");
        ...
        {
            return this.Equals(input as PrepareMintTransactionRequestSchemaQrc721);
        }

        /// <summary>
        /// Returns true if PrepareMintTransactionRequestSchemaQrc721 instances are equal
        /// </summary>
        /// <param name="input">Instance of PrepareMintTransactionRequestSchemaQrc721 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrepareMintTransactionRequestSchemaQrc721 input)
        {
            if (input == null)
                return false;
