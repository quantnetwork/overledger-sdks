...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PrepareApproveDebitTransactionRequestSchema :  IEquatable<PrepareApproveDebitTransactionRequestSchema>, IValidatableObject
    {
        ...
        public PrepareApproveDebitTransactionRequestSchema(string urgency = default(string), ApproveRequestDetailsSchema requestDetails = default(ApproveRequestDetailsSchema), Location location = default(Location), string type = default(string))
        {
