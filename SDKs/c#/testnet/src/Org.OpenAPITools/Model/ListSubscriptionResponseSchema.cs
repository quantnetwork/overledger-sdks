...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListSubscriptionResponseSchema :  IEquatable<ListSubscriptionResponseSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSubscriptionResponseSchema" /> class.
        /// </summary>
        ...
        public ListSubscriptionResponseSchema(SubscriptionDetailsSchema subscriptionDetails = default(SubscriptionDetailsSchema), DateTime subscribedTime = default(DateTime), DateTime lastUpdatedTime = default(DateTime), string callbackUrl = default(string), string subscriptionId = default(string), string type = default(string))
        {
        ...
        public SubscriptionDetailsSchema SubscriptionDetails { get; set; }
        ...
        {
            return this.Equals(input as ListSubscriptionResponseSchema);
        }

        /// <summary>
        /// Returns true if ListSubscriptionResponseSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of ListSubscriptionResponseSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListSubscriptionResponseSchema input)
        {
            if (input == null)
                return false;
