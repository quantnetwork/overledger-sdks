...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PrepareCreditTransactionRequestSchema :  IEquatable<PrepareCreditTransactionRequestSchema>, IValidatableObject
    {
        ...
        public PrepareCreditTransactionRequestSchema(string urgency = default(string), CreditRequestDetailsSchema requestDetails = default(CreditRequestDetailsSchema), Location location = default(Location), string type = default(string))
        {
