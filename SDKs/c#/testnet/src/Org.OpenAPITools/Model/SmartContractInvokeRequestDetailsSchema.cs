...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SmartContractInvokeRequestDetailsSchema :  IEquatable<SmartContractInvokeRequestDetailsSchema>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as SmartContractInvokeRequestDetailsSchema);
        }

        /// <summary>
        /// Returns true if SmartContractInvokeRequestDetailsSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of SmartContractInvokeRequestDetailsSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SmartContractInvokeRequestDetailsSchema input)
        {
            if (input == null)
                return false;
