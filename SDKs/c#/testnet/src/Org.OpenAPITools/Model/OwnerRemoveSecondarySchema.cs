...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OwnerRemoveSecondarySchema :  IEquatable<OwnerRemoveSecondarySchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OwnerRemoveSecondarySchema" /> class.
        /// </summary>
        /// <param name="accountId">Unique Identifier of the owner.</param>
        /// <param name="unit">The unit of this currency/token.</param>
        public OwnerRemoveSecondarySchema(string accountId = default(string), string unit = default(string))
        {
        ...
        {
            return this.Equals(input as OwnerRemoveSecondarySchema);
        }

        /// <summary>
        /// Returns true if OwnerRemoveSecondarySchema instances are equal
        /// </summary>
        /// <param name="input">Instance of OwnerRemoveSecondarySchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OwnerRemoveSecondarySchema input)
        {
            if (input == null)
                return false;
