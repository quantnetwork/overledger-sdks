...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateSubscriptionRequestSchema :  IEquatable<CreateSubscriptionRequestSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSubscriptionRequestSchema" /> class.
        /// </summary>
        /// <param name="ids">ids.</param>
        /// <param name="callbackUrl">callbackUrl.</param>
        /// <param name="type">type.</param>
        public CreateSubscriptionRequestSchema(List<string> ids = default(List<string>), string callbackUrl = default(string), string type = default(string))
        {
            this.Ids = ids;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateSubscriptionRequestSchema {\n");
        ...
        {
            return this.Equals(input as CreateSubscriptionRequestSchema);
        }

        /// <summary>
        /// Returns true if CreateSubscriptionRequestSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSubscriptionRequestSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSubscriptionRequestSchema input)
        {
            if (input == null)
                return false;
