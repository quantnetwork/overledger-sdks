...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SmartContractDestinationSchema :  IEquatable<SmartContractDestinationSchema>, IValidatableObject
    {
        ...
        public SmartContractDestinationSchema(string destinationId = default(string), SmartContractSchema smartContract = default(SmartContractSchema), SmartContractPaymentSchema payment = default(SmartContractPaymentSchema))
        {
