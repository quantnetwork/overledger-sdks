...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreateSmartContractMonitoringSchema :  IEquatable<CreateSmartContractMonitoringSchema>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as CreateSmartContractMonitoringSchema);
        }

        /// <summary>
        /// Returns true if CreateSmartContractMonitoringSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSmartContractMonitoringSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSmartContractMonitoringSchema input)
        {
            if (input == null)
                return false;
